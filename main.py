...
def populate_spells():
    ...
    sorts = [
        ...
        ("oracle_touche_novice",  "Touche du Destin Novice",       '["oracle"]', 1, 1, 0, 3, 0, "foi", 12, "ferveur", 0, 3, "Réduit Base prochain sort cible de Foi÷2.", "actif", "spe", '{"seuil": 2, "reduce_base_cible": "foi_half", "bonus_si_presage_exact": {"reduce_bonus_pieces": 2}}'),
        ...
        ("oracle_touche_avance",  "Touche du Destin Avancée",      '["oracle"]', 3, 3, 0, 4, 0, "foi", 22, "ferveur", 0, 3, "Stun. Présage exact : cible no regen ce tour.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_presage": true}'),
