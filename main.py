...
def populate_spells():
    ...
    sorts = [
        ...
        # P4
        ("lotus_sceau_avance",    "Sceau du Lotus Avancé",         '["moine_lotus"]', 4, 4, 12, 4, 5, "foi", 30, "ferveur", 2, 3, "Soin 22 PV + dissipe tous négatifs. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 22, "concentre_bonus": 5, "cleanse_target": true, "cleanse_all": true}'),        ("lotus_frappe_eveil_avance","Frappe de l'Éveil Avancée",  '["moine_lotus"]', 4, 4, 12, 5, 4, "foi", 28, "ferveur", 0, 3, "Stun. Concentré : no regen. Perturbé : +4 Base + ignore Armure+Rob.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_concentre": true, "ignore_armor_rob_si_perturbe": true}'),        ("lotus_transfert_total_novice","Transfert Total Novice",  '["moine_lotus"]', 4, 4, 10, 4, 5, "foi", 35, "ferveur", 2, 4, "Soin 25 PV allié, perd 8 PV. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 25, "concentre_bonus": 5, "self_dmg": 8}'),        ("lotus_secret",          "Secret du Monastère (Bonus)",   '["moine_lotus"]', 4, 4, 0, 3, 0, "foi", 15, "ferveur", 1, 2, "Connaissance interdite du Temple.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Temple révèle connaissance interdite : org secrète, poison rare, technique oubliée ou maladie incurable."}'),
