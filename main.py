...
def init_db():
    ...
    try: conn.execute("ALTER TABLE joueurs ADD COLUMN gm_bonus_base_item INTEGER DEFAULT 0")
    except: pass
...
def populate_spells():
    ...
    sorts = [
        ...
        ("moine_rupture_rythme_novice", "Rupture de Rythme Novice", '["moine_poing_vide"]', 1, 1, 0, 2, 0, "phy", 2, "tension", 0, 3, "Force le passage immédiat en phase Expire.", "actif", "spe", '{"seuil": 1, "force_phase": "expire"}'),
        ...
        ("moine_ancrage_souffle", "Ancrage du Souffle", '["moine_poing_vide"]', 2, 2, 0, 2, 0, "phy", 1, "tension", 0, 3, "Prolonge la phase Retenue d'un tour supplémentaire.", "actif", "spe", '{"seuil": 1, "force_phase": "retenue_extend"}'),
        ...
        ("moine_rupture_rythme_avancee", "Rupture de Rythme Avancée", '["moine_poing_vide"]', 3, 3, 0, 3, 0, "phy", 2, "tension", 0, 4, "Force le passage en Expire. Le coup suivant en Expire ignore la Robustesse.", "actif", "spe", '{"seuil": 1, "force_phase": "expire", "ignore_rob_prochain_expire": true}'),
        ...
        ("moine_inversion_souffle", "Inversion du Souffle", '["moine_poing_vide"]', 4, 4, 0, 3, 0, "phy", 3, "tension", 0, 5, "Repasse d'Expire à Retenue au lieu d'Inspire.", "actif", "spe", '{"seuil": 1, "force_phase": "inverse"}'),
        ...
        ("moine_cent_un_souffle", "Cent-et-Unième Souffle (Bonus)", '["moine_poing_vide"]', 5, 5, 0, 4, 0, "phy", 0, "tension", 0, 1, "1x/combat : régénère tout le Ki et force le retour en Retenue.", "utilitaire", "spe", '{"seuil": 2, "force_phase": "retenue_extend"}'),
        ...
        # P1
        ("ombres_affut_silencieux", "Affût Silencieux (Préparation)", '["maitre_ombres"]', 1, 1, 0, 2, 0, "phy", 1, "tension", 0, 1, "Votre prochaine attaque via /attaque bénéficie du Sneak Attack, même défendue.", "actif", "spe", '{"seuil": 1, "rp_effect": "Usage unique en Phase de Chasse (Tours 1-2)."}'),
        ...
        # P3
        ("ombres_marque_chasseur", "Marque du Chasseur (Préparation)", '["maitre_ombres"]', 3, 3, 0, 3, 0, "phy", 2, "tension", 0, 1, "Désigne une cible : votre prochaine Exécution contre elle est facilitée.", "actif", "spe", '{"seuil": 1, "rp_effect": "Usage unique en Phase de Chasse."}'),
        ...
        # P4
        ("ombres_embuscade_totale", "Embuscade Totale (Préparation, 1x/combat)", '["maitre_ombres"]', 4, 4, 0, 4, 0, "phy", 3, "tension", 0, 1, "Prochaine attaque via /attaque : Sneak Attack à +100%, peu importe la défense.", "actif", "spe", '{"seuil": 1, "rp_effect": "Usage unique en Phase de Chasse."}'),
        ...
        ("ombres_derniere_ombre", "Dernière Ombre (Bonus)", '["maitre_ombres"]', 5, 5, 0, 4, 0, "phy", 0, "tension", 0, 5, "1x/combat : régénère 3 Tension et réactive une Préparation déjà utilisée.", "utilitaire", "spe", '{"seuil": 2, "generate_tension": 3}'),
        ...
        ("chasse_appel_familier", "Appel du Familier (Bonus)", '["magie_chasse"]', 1, 1, 0, 2, 0, "esp", 8, "mana", 0, 4, "Invoque/rappelle le Familier, ou lui ordonne d'attaquer immédiatement.", "utilitaire", "spe", '{"seuil": 1, "invoque_familier": true}'),
        ("chasse_repas_chasseur", "Repas du Chasseur (Bonus)", '["magie_chasse"]', 1, 1, 0, 2, 0, "esp", 5, "mana", 0, 1, "Prépare un Plat de Chasseur : buff mineur pour le prochain combat.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Prépare un Plat de Chasseur donnant un buff mineur pour le prochain combat. Nécessite un /repos avant le combat."}'),
        ("chasse_piege_racine", "Piège Racine (Bonus)", '["magie_chasse"]', 1, 1, 0, 3, 0, "esp", 20, "mana", 0, 3, "Pose un piège. Si seuil atteint : Enracinement au prochain acte de la cible.", "utilitaire", "spe", '{"seuil": 2, "pose_piege": {"status": {"root": 1}}}'),
        # P2
        ...
        ("chasse_piege_machoires", "Piège à Mâchoires (Bonus)", '["magie_chasse"]', 2, 2, 4, 3, 2, "esp", 28, "mana", 0, 3, "Pose un piège. Si seuil atteint : dégâts + Enracinement 2 tours.", "utilitaire", "spe", '{"seuil": 2, "pose_piege": {"degats": 4, "status": {"root": 2}}}'),
        ("chasse_cor_chasse", "Cor de Chasse (Bonus)", '["magie_chasse"]', 2, 2, 0, 2, 0, "esp", 10, "mana", 0, 3, "Soigne le Familier de 30% de ses PV max, ou le rappelle à 50%.", "utilitaire", "spe", '{"seuil": 1, "soigne_familier_pct": 30}'),
        ...
        ("chasse_piege_explosif", "Piège Explosif (Bonus)", '["magie_chasse"]', 3, 3, 6, 3, 3, "esp", 36, "mana", 0, 4, "Pose un piège. Si seuil atteint : dégâts de zone + Étourdissement.", "utilitaire", "spe", '{"seuil": 2, "pose_piege": {"degats": 6, "status": {"stun": 1}, "aoe": true}}'),
        ("chasse_charge_familier", "Charge du Familier (Bonus)", '["magie_chasse"]', 3, 3, 0, 3, 0, "esp", 14, "mana", 0, 3, "Le Familier attaque immédiatement pour (niveau x2) dégâts.", "utilitaire", "spe", '{"seuil": 1, "familier_attaque_mult": 2}'),
        ...
        ("chasse_balle_explosive_chargee", "Balle Explosive Chargée (coûteux)", '["magie_chasse"]', 3, 3, 16, 4, 5, "esp", 30, "mana", 0, 5, "Dégâts très élevés. Étourdissement si les 4 dés touchent (seuil 4).", "actif", "spe", '{"seuil": 4, "status": {"stun": 1}}'),
        # P4
        ...
        ("chasse_piege_ours_renforce", "Piège à Ours Renforcé (Bonus)", '["magie_chasse"]', 4, 4, 8, 4, 3, "esp", 48, "mana", 0, 4, "Pose un piège. Si seuil atteint : dégâts + Enracinement + malus Base.", "utilitaire", "spe", '{"seuil": 3, "pose_piege": {"degats": 8, "status": {"root": 2}}}'),
        ...
        ("chasse_piege_mortel", "Piège Mortel (Bonus)", '["magie_chasse"]', 5, 5, 10, 5, 4, "esp", 65, "mana", 0, 5, "Pose un piège. Si seuil atteint : dégâts massifs + Enracinement, ignore Rob.", "utilitaire", "spe", '{"seuil": 3, "pose_piege": {"degats": 10, "status": {"root": 2}, "ignore_rob": true}}'),
        ...
        ("chasse_festin_legendaire", "Festin Légendaire (Bonus)", '["magie_chasse"]', 5, 5, 0, 4, 0, "esp", 15, "mana", 0, 6, "Plat de Chasseur Légendaire : effet majeur, partageable au groupe.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Effet majeur au choix avec le MJ, partageable à tout le groupe présent."}'),
...
class Personnage:
    ...
    def charger_equipement(self):
        ...
        # Reset bonuses items (accumulateurs propres, recalculés depuis les objets équipés)
        self.bonus_base_item = 0
        self.bonus_pieces_item = 0
        self.mana_max_bonus_item = 0
        self.pv_max_bonus_item = 0
        ...
        # Bonus manuels/raciaux persistants (via /set_stat, /gm_set_stat ou passifs de
        # race) : contrairement au bloc ci-dessus, ces champs ne sont PAS recalculés
    ...
    def appliquer_pallier_race(self, niveau_palier=None):
        ...
        if self.race == "Elfe":
            ...
            # +1 aux dégâts de base à chaque pallier — stocké dans gm_bonus_base_item
            # (persistant) et non bonus_base_item, qui est recalculé depuis les objets
            # équipés à chaque chargement (voir charger_equipement).
            self.gm_bonus_base_item = getattr(self, 'gm_bonus_base_item', 0) + 1
