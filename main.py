...
def populate_spells():
    ...
    sorts = [
        ...
        # --- PALLIER 1 ---
        ("sang_ciseaux_novice",   "Ciseaux de Sang Novice",       '["magie_sang"]', 1, 1, 4, 3, 2, "esp", 6, "mana", 0, 2,  "Projets deux lames de sang tranchantes.", "actif", "spe",   '{"generate_festin": 4, "no_dmg_unless_stade3": true, "seuil": 1, "status": {"hemorragie": 2}}'),
        ("sang_ombrelle_novice",  "Ombrelle Écarlate Novice (Bonus)", '["magie_sang"]', 1, 1, 0, 2, 2, "esp", 5, "mana", 0, 2, "Bouclier de sang cristallisé.", "defense", "spe", '{"generate_festin": 4, "seuil": 1, "reduce_dmg_flat": 5}'),
        ("sang_siphon_novice",    "Siphon Aristocratique Novice", '["magie_sang"]', 1, 1, 3, 3, 2, "esp", 5, "mana", 0, 2,  "Aspire le sang de la cible pour se soigner.", "actif", "spe",  '{"generate_festin": 5, "no_dmg_unless_stade3": true, "seuil": 1, "lifesteal_flat": 4}'),
        ...
        # --- PALLIER 2 ---
        ("sang_broderie_novice",  "Broderie Macabre Novice",      '["magie_sang"]', 2, 2, 5, 4, 2, "esp", 8, "mana", 0, 2,  "Tisse des fils de sang pour ligoter l'ennemi.", "actif", "spe",   '{"generate_festin": 6, "no_dmg_unless_stade3": true, "seuil": 2, "status": {"root": 2}}'),
        ("sang_baiser_novice",    "Baiser du Vampire Novice",     '["magie_sang"]', 2, 2, 0, 3, 3, "esp", 8, "mana", 0, 3,  "Morsure vampirique qui draine la vie.", "actif", "spe",    '{"generate_festin": 6, "no_dmg_unless_stade3": true, "seuil": 1, "lifesteal_flat": 6}'),
        ("sang_tenue",            "Tenue de Soirée (Bonus)",      '["magie_sang"]', 2, 2, 0, 2, 0, "esp", 6, "mana", 0, 2,  "Illusion de noblesse vampirique.", "utilitaire", "spe",  '{"generate_festin": 5, "rp_effect": "Avantage sur les jets d\'Oral et de Discrétion pendant 1 scène."}'),
        ...
        # --- PALLIER 3 ---
        ("sang_ciseaux",          "Ciseaux de Sang",              '["magie_sang"]', 3, 3, 9, 4, 3, "esp", 12, "mana", 0, 2,  "Lames de sang renforcées par le Festin.", "actif", "spe",   '{"generate_festin": 7, "no_dmg_unless_stade3": true, "seuil": 1, "status": {"hemorragie": 3}}'),
        ("sang_ombrelle",         "Ombrelle Écarlate (Bonus)",    '["magie_sang"]', 3, 3, 0, 3, 3, "esp", 10, "mana", 0, 2,  "Bouclier de sang avancé avec contre-attaque.", "defense", "spe",  '{"generate_festin": 7, "seuil": 2, "reduce_dmg_flat": 10, "reflect_dmg_percent": 30}'),
        ("sang_siphon",           "Siphon Aristocratique",        '["magie_sang"]', 3, 3, 8, 4, 3, "esp", 12, "mana", 0, 2,  "Drain puissant qui nourrit abondamment.", "actif", "spe",    '{"generate_festin": 8, "no_dmg_unless_stade3": true, "seuil": 1, "lifesteal_flat": 10}'),
        ("sang_banquet",          "Règles du Banquet (Bonus)",    '["magie_sang"]', 3, 3, 0, 2, 0, "esp", 10, "mana", 0, 3,  "Impose les règles de l'aristocratie vampirique.", "utilitaire", "spe",  '{"generate_festin": 7, "rp_effect": "Force une cible humanoïde à respecter une règle de conduite pendant 1 scène."}'),
        ...
        # --- PALLIER 4 ---
        ("sang_broderie",         "Broderie Macabre",             '["magie_sang"]', 4, 4, 13, 5, 3, "esp", 18, "mana", 0, 3,  "Les fils de sang transpercent et contorsionnent.", "actif", "spe",  '{"generate_festin": 8, "no_dmg_unless_stade3": true, "seuil": 2, "status": {"root": 2, "hemorragie": 2}}'),
        ("sang_baiser",           "Baiser du Vampire",            '["magie_sang"]', 4, 4, 0, 4, 4, "esp", 16, "mana", 0, 3,  "Drain vampirique total : sang, mana et vitalité.", "actif", "spe",   '{"generate_festin": 9, "no_dmg_unless_stade3": true, "seuil": 2, "lifesteal_flat": 14, "restore_mana": 5}'),
        ("sang_terreur",          "Aura de Terreur (Bonus)",      '["magie_sang"]', 4, 4, 0, 3, 0, "esp", 14, "mana", 0, 4,  "Rayonne une terreur aristocratique paralysante.", "utilitaire", "spe",  '{"generate_festin": 8, "seuil": 2, "rp_effect": "Applique la Peur à tous les ennemis humanoïdes dans 10m. Jet de résistance ou fuite."}'),
        ...
        # --- PALLIER 5 ---
        ("sang_ciseaux_avance",   "Ciseaux de Sang Avancé",       '["magie_sang"]', 5, 5, 18, 4, 5, "esp", 24, "mana", 0, 3,  "La forme ultime : une volée de lames inévitables.", "actif", "spe",  '{"generate_festin": 10, "no_dmg_unless_stade3": true, "seuil": 1, "status": {"hemorragie": 4}, "aoe": true}'),
        ("sang_ombrelle_avance",  "Ombrelle Écarlate Avancée (Bonus)",'["magie_sang"]',5, 5, 0, 3, 4, "esp", 22, "mana", 0, 3, "Forteresse de sang impénétrable.", "defense", "spe", '{"generate_festin": 10, "seuil": 2, "reduce_dmg_dynamic": true, "reflect_dmg_percent": 50}'),
        ("sang_siphon_avance",    "Siphon Aristocratique Avancé", '["magie_sang"]', 5, 5, 15, 5, 4, "esp", 28, "mana", 0, 3,  "Drain total : vide la cible de son essence vitale.", "actif", "spe",   '{"generate_festin": 10, "no_dmg_unless_stade3": true, "seuil": 2, "lifesteal_flat": 20, "restore_mana": 10}'),
        ("sang_carnaval",         "L'Heure du Carnaval (Bonus)",  '["magie_sang"]', 5, 5, 0, 3, 0, "esp", 20, "mana", 0, 5,  "Transformation en Seigneur Vampire : forme ultime.", "utilitaire", "spe",  '{"generate_festin": 10, "seuil": 2, "self_status": {"mode_sang": 3}, "rp_effect": "Transformation 3 tours : toutes les dépenses de Mana sont payées en PV, dégâts vampiriques doublés."}'),
        ...
        # --- PALLIER 1 ---
        ("elem_flammes_novice",   "Jet de Flammes Novice",         '["magie_elementaire"]', 1, 1, 5, 3, 2, "esp", 5, "mana", 0, 2,  "Projette un jet de feu concentré.", "actif", "spe",  '{"generate_charge": "feu", "status": {"brulure": 1}}'),
        ("elem_souffle_novice",   "Souffle Hivernal Novice (Bonus)",'["magie_elementaire"]', 1, 1, 0, 2, 2, "esp", 5, "mana", 0, 2,  "Souffle d'air glacé ralentissant.", "defense", "spe", '{"generate_charge": "glace", "seuil": 1, "status": {"root": 1}}'),
        ("elem_etincelle_novice", "Étincelle Statique Novice",     '["magie_elementaire"]', 1, 1, 4, 3, 2, "esp", 4, "mana", 0, 2,  "Décharge électrostatique rapide.", "actif", "spe",  '{"generate_charge": "foudre", "seuil": 2, "self_status": {"hate": 1}}'),
        ...
        # --- PALLIER 2 ---
        ("elem_lance_glace_novice","Lance de Glace Novice",        '["magie_elementaire"]', 2, 2, 6, 4, 2, "esp", 7, "mana", 0, 2,  "Projette un pic de glace acéré.", "actif", "spe",  '{"generate_charge": "glace", "status": {"gel": 1}}'),
        ("elem_bourrasque_novice","Bourrasque Novice (Bonus)",      '["magie_elementaire"]', 2, 2, 0, 3, 2, "esp", 6, "mana", 0, 2,  "Rafale de vent tranchante.", "actif", "spe",  '{"generate_charge": "air", "seuil": 2, "status": {"root": 1}}'),
        ...
        # --- PALLIER 3 ---
        ("elem_flammes",          "Jet de Flammes",                '["magie_elementaire"]', 3, 3, 10, 3, 3, "esp", 12, "mana", 0, 2,  "Jet de flammes intense et dévastateur.", "actif", "spe",  '{"generate_charge": "feu", "status": {"brulure": 3}}'),
        ("elem_lance_glace",      "Lance de Glace",                '["magie_elementaire"]', 3, 3, 9, 4, 3, "esp", 11, "mana", 0, 2,  "Lance de glace solide et perforante.", "actif", "spe",  '{"generate_charge": "glace", "seuil": 1, "status": {"gel": 1}, "guaranteed_dmg": 8}'),
        ("elem_eclair",           "Éclair de Choc",                '["magie_elementaire"]', 3, 3, 8, 4, 2, "esp", 10, "mana", 0, 2,  "Éclair de foudre paralysant.", "actif", "spe",  '{"generate_charge": "foudre", "seuil": 2, "status": {"stun": 1}}'),
        ...
        ("elem_mur_vent",         "Mur de Vent (Bonus)",           '["magie_elementaire"]', 3, 3, 0, 3, 3, "esp", 10, "mana", 0, 3,  "Crée un mur d'air protecteur.", "defense", "spe",  '{"generate_charge": "air", "seuil": 1, "reduce_dmg_flat": 8, "rp_effect": "Dévie projectiles et attaques à distance."}'),

        # --- PALLIER 4 ---
        ("elem_bourrasque",       "Bourrasque",                    '["magie_elementaire"]', 4, 4, 12, 5, 3, "esp", 16, "mana", 0, 2,  "Rafale déchaînée qui projette les ennemis.", "actif", "spe",  '{"generate_charge": "air", "seuil": 2, "status": {"stun": 1}, "aoe": true}'),
        ("elem_supernova",        "Supernova",                     '["magie_elementaire"]', 4, 4, 16, 4, 5, "esp", 20, "mana", 0, 3,  "Explosion ardente consumant tout autour.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 2, "status": {"brulure": 4}, "aoe": true}'),
        ("elem_coeur_givre",      "Cœur de Givre (Bonus)",         '["magie_elementaire"]', 4, 4, 0, 3, 0, "esp", 14, "mana", 0, 3,  "Noyau de glace qui ralentit toute la zone.", "utilitaire", "spe",  '{"generate_charge": "glace", "seuil": 2, "rp_effect": "Réduit l\'initiative de tous les ennemis de -3 pendant 2 tours."}'),
        ...
        # --- PALLIER 5 ---
        ("elem_tempete",          "Tempête Apocalyptique",         '["magie_elementaire"]', 5, 5, 20, 5, 6, "esp", 35, "mana", 0, 4,  "Déchaîne les 4 éléments simultanément.", "actif", "spe",  '{"generate_charge": "foudre", "generate_charge_2": "air", "seuil": 3, "aoe": true, "status": {"stun": 1}}'),
        ("elem_zenith",           "Zénith Solaire (Bonus)",        '["magie_elementaire"]', 5, 5, 0, 3, 0, "esp", 30, "mana", 0, 5,  "Invoque le soleil pour brûler la zone.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 2, "status": {"brulure": 5}, "aoe": true}'),
        ("elem_prison_cristal",   "Prison de Cristal",             '["magie_elementaire"]', 5, 5, 18, 5, 4, "esp", 32, "mana", 0, 4,  "Emprisonne la cible dans un cristal de glace massif.", "actif", "spe",  '{"generate_charge": "glace", "seuil": 3, "status": {"stun": 2}, "ignore_armor": true}'),
        ...
        ("elem_eruption",         "Éruption Primordiale",          '["magie_elementaire"]', 5, 5, 25, 5, 8, "esp", 45, "mana", 0, 5,  "L'explosion élémentaire ultime.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 3, "aoe": true, "status": {"brulure": 5}, "execute_percent": 15}'),
        ...
        ("grav_onde_novice",      "Onde Répulsive Novice",         '["magie_gravitationnelle"]', 1, 1, 4, 3, 2, "esp", 5, "mana", 0, 2, "Inverse brutalement la pesanteur.", "actif", "spe", '{"generate_lestage": 1, "seuil": 2}'),
        ("grav_pression_novice",  "Pression Gravitationnelle Novice",'["magie_gravitationnelle"]',1, 1, 0, 3, 0, "esp", 6, "mana", 0, 2, "Augmente la pesanteur autour des membres inférieurs.", "actif", "spe", '{"generate_lestage_cond": {"base": 0, "bonus_si_lestage": 1, "seuil_lestage": 2}, "status": {"root": 1}, "seuil": 2}'),
        ...
        # P2
        ("grav_ecrasement_novice","Écrasement Orbital Novice",     '["magie_gravitationnelle"]', 2, 2, 5, 3, 3, "esp", 8, "mana", 0, 3, "La gravité plaque la cible au sol.", "actif", "spe", '{"generate_lestage": 2, "seuil": 2, "status_if_lestage_3": {"root": 1}}'),
        ("grav_attraction_novice","Attraction Zonale Novice",      '["magie_gravitationnelle"]', 2, 2, 4, 4, 2, "esp", 9, "mana", 0, 3, "Puits de gravité aspirant les corps.", "actif", "spe", '{"generate_lestage": 1, "seuil": 2, "aoe": true}'),
        ("grav_bouclier_novice",  "Bouclier Inertiel Novice",      '["magie_gravitationnelle"]', 2, 2, 0, 3, 0, "esp", 7, "mana", 0, 3, "Redirige la force d'un impact entrant.", "defense", "spe", '{"reduce_dmg_flat": 8, "seuil": 2, "lestage_sur_attaquant": 1}'),
        ...
        # P3
        ("grav_traction_avance",  "Traction Avancée",              '["magie_gravitationnelle"]', 3, 3, 9, 4, 3, "esp", 13, "mana", 0, 2, "La masse d'un astre imaginaire s'abat.", "actif", "spe", '{"generate_lestage": 3, "seuil": 2}'),
        ("grav_inversion",        "Champ d'Inversion",             '["magie_gravitationnelle"]', 3, 3, 7, 5, 2, "esp", 15, "mana", 0, 4, "Inverse la gravité d'une zone entière.", "actif", "spe", '{"generate_lestage": 1, "seuil": 3, "status": {"stun": 1}, "aoe": true}'),
        ("grav_compression",      "Onde de Compression",           '["magie_gravitationnelle"]', 3, 3, 6, 4, 2, "esp", 11, "mana", 0, 3, "Compresse l'air autour de la cible.", "actif", "spe", '{"seuil": 2, "ignore_armor_si_alourdi": true, "status_si_alourdi": {"hemorragie": 1}}'),
        ("grav_manteau",          "Manteau Stellaire (Bonus)",     '["magie_gravitationnelle"]', 3, 3, 0, 3, 0, "esp", 12, "mana", 0, 3, "Distorsion gravitationnelle créant une armure.", "defense", "spe", '{"reduce_dmg_flat": 8, "seuil": 2}'),
        ...
        # P4
        ("grav_compression_avance","Compression Gravitationnelle", '["magie_gravitationnelle"]', 4, 4, 13, 4, 5, "esp", 22, "mana", 0, 3, "Broie la cible par pesanteur concentrée.", "actif", "spe", '{"generate_lestage": 4, "seuil": 2, "bonus_si_singularite": 12}'),
        ("grav_effondrement",     "Effondrement de Zone",          '["magie_gravitationnelle"]', 4, 4, 11, 5, 4, "esp", 20, "mana", 0, 4, "Convertit les Lestages en dégâts.", "actif", "spe", '{"consume_lestage_all": true, "dmg_per_lestage": 3, "seuil": 3, "aoe": true}'),
        ("grav_pression_avance",  "Pression Gravitationnelle Avancée",'["magie_gravitationnelle"]',4, 4, 10, 4, 4, "esp", 18, "mana", 0, 3, "La pesanteur triple d'intensité.", "actif", "spe", '{"generate_lestage": 3, "seuil": 3, "double_rupture": true}'),
        ("grav_saut",             "Saut Gravitationnel (Bonus)",   '["magie_gravitationnelle"]', 4, 4, 0, 3, 0, "esp", 18, "mana", 0, 4, "Téléportation vers tout point visible à 300m.", "utilitaire", "spe", '{"rp_effect": "Téléportation instantanée vers tout point visible à moins de 300m."}'),
        ...
        # P5
        ("grav_stellaire",        "Effondrement Stellaire",        '["magie_gravitationnelle"]', 5, 5, 25, 6, 8, "esp", 45, "mana", 0, 5, "La puissance d'un astre mourant s'abat.", "actif", "spe", '{"generate_lestage": 5, "seuil": 4, "aoe": true, "check_singularite_all": true}'),
        ("grav_non_retour",       "Point de Non-Retour",           '["magie_gravitationnelle"]', 5, 5, 18, 5, 7, "esp", 35, "mana", 0, 4, "Distorsion permanente dans la masse de la cible.", "actif", "spe", '{"reset_lestage_plus_2": true, "seuil": 3}'),
        ("grav_bouclier_avance",  "Bouclier Inertiel Avancé",      '["magie_gravitationnelle"]', 5, 5, 0, 5, 0, "esp", 30, "mana", 0, 4, "Sphère gravitationnelle renvoyant les impacts.", "defense", "spe", '{"reduce_dmg_flat": 20, "seuil": 3, "lestage_sur_attaquant_multi": true}'),
        ...
        # P1
        ("ombre_marquage_novice", "Marquage Silencieux",           '["loge_ombre"]', 1, 1, 3, 3, 1, "esp", 6, "mana", 0, 3, "Filament invisible liant le mage à sa proie.", "actif", "spe", '{"pose_designation": 1, "seuil": 1}'),
        ("ombre_voile",           "Voile d'Ombre (Bonus)",         '["loge_ombre"]', 1, 1, 0, 2, 0, "esp", 5, "mana", 0, 2, "Invisibilité 10min.", "utilitaire", "spe", '{"rp_effect": "Invisibilité visuelle 10min (annulée si attaque ou cri)."}'),
        ...
        ("ombre_frappe_novice",   "Frappe dans l'Ombre Novice",    '["loge_ombre"]', 1, 1, 5, 3, 2, "esp", 7, "mana", 0, 2, "Sort basique amplifié par la préparation.", "actif", "spe", '{"seuil": 2, "bonus_si_designation": {"status": {"root": 1}}}'),
        # P2
        ("ombre_filet_novice",    "Filet Invisible Novice",        '["loge_ombre"]', 2, 2, 5, 3, 2, "esp", 7, "mana", 0, 3, "Réseau de fils coupant les voies d'action.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "ignore_rob_si_designation": true}'),
        ("ombre_perturb_novice",  "Perturbation Neurale Novice",   '["loge_ombre"]', 2, 2, 0, 3, 0, "esp", 8, "mana", 0, 3, "Impulsion brouillant les pensées.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "consomme_designation_bonus": true}'),
        ("ombre_marquage_avance", "Marquage Avancé",               '["loge_ombre"]', 2, 2, 4, 3, 2, "esp", 10, "mana", 0, 3, "Désignation gravée dans l'aura de la cible.", "actif", "spe", '{"pose_designation": 1, "seuil": 2, "bonus_si_deja_designee": 1}'),
        ...
        # P3
        ("ombre_marquage_profond","Marquage Profond",              '["loge_ombre"]', 3, 3, 3, 3, 2, "esp", 10, "mana", 0, 3, "Désignation persistante même après consommation.", "actif", "spe", '{"pose_designation": 2, "seuil": 2}'),
        ("ombre_paralysie_novice","Paralysie Neurale Novice",      '["loge_ombre"]', 3, 3, 7, 4, 2, "esp", 12, "mana", 0, 3, "Paralyse le système nerveux supérieur.", "actif", "spe", '{"seuil": 2, "no_bonus_action_next_turn": true}'),
        ("ombre_frappe_avance",   "Frappe dans l'Ombre Avancée",   '["loge_ombre"]', 3, 3, 7, 4, 3, "esp", 14, "mana", 0, 3, "Sort de zone masqué dans un nuage de mana.", "actif", "spe", '{"seuil": 2, "aoe": true, "double_dmg_si_designation": true}'),
        ("ombre_effacement",      "Effacement de Mémoire (Bonus)", '["loge_ombre"]', 3, 3, 0, 3, 0, "esp", 10, "mana", 0, 2, "Efface 1h de mémoire d'un PNJ.", "utilitaire", "spe", '{"rp_effect": "Efface jusqu\'à 1h de mémoire d\'un PNJ ciblé. Ne fonctionne pas sur PJs."}'),
        ...
        # P4
        ("ombre_sentence_letale", "Sentence Létale",               '["loge_ombre"]', 4, 4, 12, 4, 5, "esp", 20, "mana", 0, 3, "Dégâts massifs ignorant l'Armure. Requiert Désignation.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "seuil": 3}'),
        ("ombre_champ_iso",       "Champ d'Isolation",             '["loge_ombre"]', 4, 4, 0, 4, 0, "esp", 18, "mana", 0, 4, "La cible ne peut cibler plusieurs ennemis ce tour.", "actif", "spe", '{"seuil": 3, "rp_effect": "La cible ne peut pas utiliser sorts de zone ce tour."}'),
        ("ombre_paralysie_avance","Paralysie Neurale Avancée",     '["loge_ombre"]', 4, 4, 9, 4, 3, "esp", 18, "mana", 0, 4, "Coupe les connexions motrices supérieures.", "actif", "spe", '{"seuil": 3, "status": {"stun": 2}, "ignore_rob_si_designation": true}'),
        ("ombre_extraction",      "Extraction d'Information (Bonus)",'["loge_ombre"]', 4, 4, 0, 4, 0, "esp", 15, "mana", 0, 3, "Plonge dans les souvenirs d'une cible inconsciente.", "utilitaire", "spe", '{"rp_effect": "Accède aux souvenirs récents d\'une cible inconsciente. MJ révèle 3 infos."}'),
        ...
        # P5
        ("ombre_execution",       "Exécution de l'Ombre",          '["loge_ombre"]', 5, 5, 20, 5, 6, "esp", 30, "mana", 0, 3, "La Confrérie a jugé. Dégâts massifs ignorant toute défense.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "ignore_rob": true, "seuil": 3, "execute_note": true}'),
        ("ombre_sentence_avance", "Sentence Létale Avancée",       '["loge_ombre"]', 5, 5, 16, 5, 7, "esp", 35, "mana", 0, 3, "Le Grand Régulateur n'a pas besoin de deux balles.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "seuil": 3, "execute_percent_si_designation": 30}'),
        ("ombre_marquage_fantome","Marquage Fantôme",               '["loge_ombre"]', 5, 5, 2, 3, 1, "esp", 12, "mana", 0, 2, "Pose Désignation après un kill.", "actif", "spe", '{"pose_designation": 1, "seuil": 1}'),
        ("ombre_disparition",     "Disparition Totale (Bonus)",    '["loge_ombre"]', 5, 5, 0, 5, 0, "esp", 35, "mana", 0, 6, "Vous et votre groupe introuvables 24h.", "utilitaire", "spe", '{"rp_effect": "Vous et votre groupe êtes introuvables pendant 24h. Aucun sort de localisation."}'),
        ...
        ("estoc_quarte_novice",   "Quarte Novice (Passe ⚔️)",      '["ecole_estoc"]', 1, 1, 4, 3, 2, "phy", 1, "tension", 0, 2, "Dévie la lame adverse. Pose passe_active.", "actif", "spe", '{"pose_passe": true, "seuil": 2}'),
        ...
        ("estoc_feinte",          "Feinte Légère (Bonus)",          '["ecole_estoc"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 2, "Révèle la cible déclarée d'un PNJ.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Combat : révèle cible déclarée d\'un PNJ ce tour."}'),
        ...
        # P2
        ("estoc_sixte",           "Sixte Filée (Passe ⚔️)",        '["ecole_estoc"]', 2, 2, 5, 4, 2, "phy", 1, "tension", 0, 2, "Déviation en arc retournant l'élan adverse.", "actif", "spe", '{"pose_passe": true, "seuil": 2, "status_si_clash_gagne": {"stun": 1}}'),
        ("estoc_botte_novice",    "Botte Secrète Novice (Estoc 🎯)",'["ecole_estoc"]', 2, 2, 7, 4, 2, "phy", 2, "tension", 0, 2, "Exploite l'angle mort révélé par la déviation.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 1}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_desarme",         "Désarmement Partiel",            '["ecole_estoc"]', 2, 2, 0, 3, 0, "phy", 1, "tension", 0, 3, "Tord le poignet avec précision d'horloger.", "actif", "spe", '{"seuil": 2, "rp_effect": "Prochaine attaque de la cible perd 2 Pièces ce tour."}'),
        ...
        # P3
        ("estoc_tierce",          "Tierce Croisée (Passe ⚔️)",     '["ecole_estoc"]', 3, 3, 6, 5, 2, "phy", 2, "tension", 0, 2, "Parade croisée absorbant l'impact.", "actif", "spe", '{"pose_passe": true, "seuil": 2, "status_si_clash_gagne": {"root": 1}}'),
        ("estoc_lunge_novice",    "Lunge Novice (Estoc 🎯)",        '["ecole_estoc"]', 3, 3, 8, 4, 3, "phy", 2, "tension", 0, 2, "Fente explosive couvrant distance impossible.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 2}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_riposte",         "Riposte Foudroyante",            '["ecole_estoc"]', 3, 3, 7, 4, 3, "phy", 2, "tension", 0, 3, "Convertit la Tension récupérée en frappe.", "actif", "spe", '{"seuil": 2, "bonus_si_passe_ce_tour": {"base_bonus": 2}}'),
        ...
        # P4
        ("estoc_parade_absolue",  "Parade Absolue (Passe ⚔️)",     '["ecole_estoc"]', 4, 4, 8, 5, 3, "phy", 2, "tension", 0, 3, "Parade parfaite. passe_active + parade_absorb 5.", "actif", "spe", '{"pose_passe": true, "pose_parade_absorb": 5, "seuil": 3}'),
        ("estoc_botte_avance",    "Botte Secrète Avancée (Estoc 🎯)",'["ecole_estoc"]', 4, 4, 10, 5, 4, "phy", 3, "tension", 0, 2, "La botte parfaite — visible trop tard.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 3}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_desarme_total",   "Désarmement Total",              '["ecole_estoc"]', 4, 4, 5, 4, 2, "phy", 2, "tension", 0, 4, "La lame vole à dix mètres.", "actif", "spe", '{"seuil": 3, "rp_effect": "La cible ne peut pas utiliser de sort offensif son prochain tour."}'),
        ("estoc_lunge_avance",    "Lunge Avancée (Estoc 🎯)",       '["ecole_estoc"]', 4, 4, 11, 5, 4, "phy", 3, "tension", 0, 3, "Fente si rapide que personne ne la voit.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 3}, "ignore_rob": true, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ...
        # P5
        ("estoc_passe_royale",    "Passe Royale (Passe ⚔️)",       '["ecole_estoc"]', 5, 5, 10, 6, 4, "phy", 3, "tension", 0, 4, "L'arme adverse revient frapper son propriétaire.", "actif", "spe", '{"pose_passe": true, "seuil": 4, "retour_degats_si_marge_3": true}'),
        ("estoc_final",           "Estoc Final (Estoc 🎯)",         '["ecole_estoc"]', 5, 5, 14, 7, 5, "phy", 4, "tension", 0, 3, "Le coup que Maître Valère ne peut décrire.", "actif", "spe", '{"seuil": 4, "status": {"hemorragie": 4}, "execute_percent": 30, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_riposte_maitre",  "Riposte du Maître (Passe ⚔️)",  '["ecole_estoc"]', 5, 5, 12, 6, 4, "phy", 3, "tension", 0, 3, "Contre-attaque simultanée à la parade.", "actif", "spe", '{"pose_passe": true, "seuil": 3, "status_si_clash_gagne": {"stun": 1, "hemorragie": 2}}'),
        ("estoc_legende",         "Légende du Cercle (Bonus)",      '["ecole_estoc"]', 5, 5, 0, 4, 0, "phy", 0, "tension", 0, 4, "Ennemi inférieur se rend avant le combat.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Ennemi non-boss de niveau inférieur refuse de combattre et se rend ou fuit."}'),
        ...
        ("nord_rugissement_novice","Rugissement Novice",           '["clan_nord"]', 1, 1, 3, 3, 1, "phy", 1, "tension", 0, 2, "Cri de guerre vacillant la résolution.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 2}}'),
        ("nord_briseur_novice",   "Briseur d'Os Novice",           '["clan_nord"]', 1, 1, 4, 3, 2, "phy", 1, "tension", 0, 2, "Vise les articulations pour affaiblir.", "actif", "spe", '{"seuil": 2, "rp_effect": "Réduit Base prochaine attaque cible de 3. Dure 1 tour."}'),
        ("nord_cracher",          "Cracher le Sang (Bonus)",       '["clan_nord"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 2, "Retire 1 stack Poison ou Brûlure.", "utilitaire", "spe", '{"seuil": 1, "cleanse_self_dot": 1, "rp_effect": "Retire 1 stack Poison ou Brûlure. Intimide PNJ qui vous a vu blessé."}'),
        ...
        # P2
        ("nord_charge_novice",    "Charge Brutale Novice",         '["clan_nord"]', 2, 2, 6, 4, 2, "phy", 2, "tension", 0, 2, "Charge pleine vitesse renversant tout.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}}'),
        ("nord_masse_novice",     "Coup de Masse Novice",          '["clan_nord"]', 2, 2, 7, 0, 0, "phy", 2, "tension", 0, 3, "7 dégâts fixes. Si Serment +4 bonus : Étourdissement.", "actif", "spe", '{"degats_fixes": 7, "stun_si_serment_bonus_4": true}'),
        ("nord_rugissement_avance","Rugissement Avancé",           '["clan_nord"]', 2, 2, 5, 4, 2, "phy", 2, "tension", 0, 3, "Cri brisant la volonté de combattre.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 3}, "apply_serment_bonus": true}'),
        ...
        # P3
        ("nord_coup_tete_avance", "Coup de Tête Avancé",           '["clan_nord"]', 3, 3, 6, 5, 2, "phy", 2, "tension", 0, 2, "Impact si violent que le sol tremble.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1, "hemorragie": 1}}'),
        ("nord_dechainnement_novice","Déchaînement Novice",        '["clan_nord"]', 3, 3, 9, 5, 3, "phy", 3, "tension", 0, 3, "Rafale de coups. Touche 2ème cible à moitié.", "actif", "spe", '{"seuil": 3, "aoe_reduit": true}'),
        ("nord_briseur_avance",   "Briseur d'Os Avancé",           '["clan_nord"]', 3, 3, 7, 4, 3, "phy", 2, "tension", 0, 3, "Fracasse l'épaule, bras inutilisable.", "actif", "spe", '{"seuil": 3, "rp_effect": "Cible ne peut pas utiliser sort offensif prochain tour.", "status_si_serment": {"hemorragie": 2}}'),
        ("nord_chant",            "Chant de Guerre (Bonus)",       '["clan_nord"]', 3, 3, 0, 3, 0, "phy", 1, "tension", 0, 3, "PNJ de faible volonté hésitent à agir.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Tous PNJ de faible volonté hésitent à agir ce tour."}'),
        ...
        # P4
        ("nord_charge_avance",    "Charge Dévastatrice",           '["clan_nord"]', 4, 4, 10, 6, 3, "phy", 3, "tension", 0, 3, "Charge de titan fracassant armures.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "ignore_armor": true}'),
        ("nord_masse_avance",     "Coup de Masse Avancé",          '["clan_nord"]', 4, 4, 11, 0, 0, "phy", 3, "tension", 0, 3, "11 dégâts fixes. Enracinement.", "actif", "spe", '{"degats_fixes": 11, "status": {"root": 1}}'),
        ("nord_dechainnement_avance","Déchaînement Avancé",        '["clan_nord"]', 4, 4, 11, 6, 4, "phy", 3, "tension", 0, 4, "Si kill : relancer sur nouvelle cible sans Tension.", "actif", "spe", '{"seuil": 3, "kill_relancer": true}'),
        ...
        # P5
        ("nord_dechainnement_total","Déchaînement Total",          '["clan_nord"]', 5, 5, 14, 7, 5, "phy", 4, "tension", 0, 4, "Rage d'une vie libérée en un instant. Zone.", "actif", "spe", '{"seuil": 4, "status": {"stun": 1}, "aoe": true}'),
        ("nord_masse_final",      "Coup de Masse Final",           '["clan_nord"]', 5, 5, 15, 0, 0, "phy", 4, "tension", 0, 4, "15 dégâts fixes. Ignore Armure. Si Serment <30% : Stun + 4 Hémos.", "actif", "spe", '{"degats_fixes": 15, "ignore_armor": true, "bonus_si_serment_30pct": {"status": {"stun": 1, "hemorragie": 4}}}'),
        ("nord_briseur_final",    "Briseur d'Os Final",            '["clan_nord"]', 5, 5, 11, 6, 4, "phy", 3, "tension", 0, 3, "Corps de l'ennemi cède entièrement.", "actif", "spe", '{"seuil": 4, "ignore_rob": true, "status": {"hemorragie": 4}, "rp_effect": "Cible ne peut pas utiliser sort offensif pendant 2 tours."}'),
        ...
        # P1
        ("legion_frappe_bouclier_novice","Frappe Bouclier Novice", '["legion_fer"]', 1, 1, 6, 3, 3, "phy", 1, "tension", 0, 2, "Percute du plat du bouclier. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "cout_zero_si_posture": true}'),
        ("legion_ancrage_novice", "Ancrage Défensif Novice",       '["legion_fer"]', 1, 1, 6, 3, 3, "phy", 1, "tension", 0, 2, "Creuse ses appuis, refuse toute progression.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "base_bonus_si_posture": 3}'),
        ("legion_tenir",          "Tenir la Ligne (Bonus)",        '["legion_fer"]', 1, 1, 0, 2, 0, "phy", 1, "tension", 0, 2, "Annule effets de déplacement forcé ce tour.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Ce tour : tous effets déplacement forcé annulés. PNJ ordinaire ne peut vous déplacer."}'),
        ...
        # P2
        ("legion_charge_novice",  "Charge Défensive Novice",       '["legion_fer"]', 2, 2, 8, 4, 3, "phy", 2, "tension", 0, 2, "Pas en avant décidé. En Posture : +2 Base.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "base_bonus_si_posture": 3}'),
        ("legion_rempart_novice", "Rempart de Corps Novice",       '["legion_fer"]', 2, 2, 0, 3, 0, "phy", 2, "tension", 0, 3, "Armure 10. En Posture : Armure 15.", "defense", "spe", '{"reduce_dmg_flat": 10, "seuil": 2, "armure_si_posture": 15}'),
        ("legion_frappe_novice",  "Frappe de Bouclier Novice",     '["legion_fer"]', 2, 2, 8, 4, 3, "phy", 2, "tension", 0, 2, "Bouclier en arme de percussion. En Posture : 0 Tension + 1 Pièce.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "cout_zero_si_posture": true, "coins_bonus_si_posture": 1}'),
        ("legion_protocole",      "Protocole de Protection (Bonus)",'["legion_fer"]', 2, 2, 0, 3, 0, "phy", 0, "tension", 0, 2, "Évacuation 20 civils sans jet.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Organise évacuation jusqu\'à 20 civils sans jet. Avantage Survie milieu urbain."}'),
        ...
        # P3
        ("legion_frappe_avance",  "Frappe Bouclier Avancée",       '["legion_fer"]', 3, 3, 10, 5, 3, "phy", 2, "tension", 0, 2, "Bouclier en arme de brisement. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1, "root": 1}, "cout_zero_si_posture": true}'),
        ("legion_zone_novice",    "Zone de Contrôle Novice",       '["legion_fer"]', 3, 3, 11, 4, 4, "phy", 2, "tension", 0, 3, "Emprise écrasante. Enracinement zone.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "aoe_reduit": true}'),
        ("legion_rempart_avance", "Rempart de Corps Avancé",       '["legion_fer"]', 3, 3, 0, 4, 0, "phy", 3, "tension", 0, 3, "Armure 18 / Posture 24. Rebond 4 dmg si bloqué.", "defense", "spe", '{"reduce_dmg_flat": 18, "seuil": 2, "armure_si_posture": 24, "rebond_si_bloque": 4}'),
        ...
        ("legion_zone_avance",    "Zone de Contrôle Avancée",      '["legion_fer"]', 4, 4, 13, 5, 5, "phy", 3, "tension", 0, 4, "Contrôle absolu. Enracinement + Stun en Posture.", "actif", "spe", '{"seuil": 3, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ("legion_frappe_bouclier_avance","Frappe de Bouclier Avancée",'["legion_fer"]',4, 4, 12, 5, 4, "phy", 3, "tension", 0, 3, "Désarticule l'épaule. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "rp_effect": "Cible ne peut pas utiliser sort offensif prochain tour.", "cout_zero_si_posture": true}'),
        ...
        # P5
        ("legion_zone_absolue",   "Zone de Contrôle Absolue",      '["legion_fer"]', 5, 5, 16, 7, 5, "phy", 4, "tension", 0, 4, "Zone. Enracinement. En Posture : Stun aussi.", "actif", "spe", '{"seuil": 4, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ("legion_bastion_avance", "Bastion Avancé",                '["legion_fer"]', 5, 5, 0, 5, 0, "phy", 4, "tension", 0, 5, "Armure 30 pendant 2 tours. -8 dmg fixes (Posture -3 supp).", "defense", "spe", '{"reduce_dmg_flat": 30, "seuil": 3, "duree_armure": 2, "reduction_fixe": 8, "reduction_bonus_si_posture": 3}'),
        ("legion_frappe_finale",  "Frappe de Bouclier Finale",     '["legion_fer"]', 5, 5, 16, 6, 6, "phy", 4, "tension", 0, 3, "Jugement divin. En Posture : 0 Tension + ignore Armure.", "actif", "spe", '{"seuil": 3, "status": {"root": 1, "stun": 1}, "cout_zero_si_posture": true, "ignore_armor_si_posture": true}'),
        ...
        # P1
        ("lotus_frappe_novice",   "Frappe du Lotus Novice",        '["moine_lotus"]', 1, 1, 4, 3, 2, "foi", 8, "ferveur", 0, 2, "Coup au centre de l'énergie vitale.", "actif", "spe", '{"seuil": 2, "status_si_concentre": {"hemorragie": 1}}'),
        ("lotus_infusion_novice", "Infusion Vitale Novice",        '["moine_lotus"]', 1, 1, 4, 3, 2, "foi", 12, "ferveur", 0, 2, "Soin 8 PV. Concentré : +5 PV. Perturbé : moitié.", "soin", "spe", '{"seuil": 2, "soin_base": 8, "concentre_bonus": 5}'),
        ("lotus_posture_novice",  "Posture du Lotus Novice",       '["moine_lotus"]', 1, 1, 0, 3, 0, "foi", 10, "ferveur", 0, 3, "Armure 6. Concentré : 9. Perturbé : 10.", "defense", "spe", '{"seuil": 1, "armure_concentre": 9, "armure_perturbe": 10, "armure_base": 6}'),
        ...
        # P2
        ("lotus_paume_novice",    "Paume du Vide Novice",          '["moine_lotus"]', 2, 2, 5, 3, 3, "foi", 15, "ferveur", 0, 3, "Désactive soins cible ce tour. Concentré : Enracinement.", "actif", "spe", '{"seuil": 2, "no_soin_next_turn": true, "status_si_concentre": {"root": 1}}'),
        ("lotus_transfert_novice","Transfert de Flux Novice",      '["moine_lotus"]', 2, 2, 5, 3, 2, "foi", 18, "ferveur", 0, 3, "Soin 12 PV allié, perd 4 PV. Concentré : +5/−2.", "soin", "spe", '{"seuil": 2, "soin_base": 12, "concentre_bonus": 5, "self_dmg": 4, "self_dmg_concentre": 2}'),
        ("lotus_frappe_eveil_novice","Frappe d'Éveil Novice",      '["moine_lotus"]', 2, 2, 6, 4, 2, "foi", 12, "ferveur", 0, 2, "Dégâts physiques. Perturbé : ignore Rob. Concentré : +5 Ferveur.", "actif", "spe", '{"seuil": 2, "ignore_rob_si_perturbe": true, "ferveur_si_concentre": 5}'),
        ...
        # P3
        ("lotus_frappe_avance",   "Frappe du Lotus Avancée",       '["moine_lotus"]', 3, 3, 8, 4, 3, "foi", 20, "ferveur", 0, 2, "Flux vital retourné. Concentré : -5 Ferveur cible. Perturbé : +4 Base.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 2}, "ferveur_cible_si_concentre": -5, "ignore_armor_si_perturbe": true}'),
        ("lotus_sceau_novice",    "Sceau du Lotus Novice",         '["moine_lotus"]', 3, 3, 6, 3, 3, "foi", 22, "ferveur", 1, 3, "Soin 14 PV + dissipe 1 négatif. Concentré : +5.", "soin", "spe", '{"seuil": 2, "soin_base": 14, "concentre_bonus": 5, "cleanse_target": true}'),
        ("lotus_paume_avance",    "Paume du Vide Avancée",         '["moine_lotus"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 3, "Stun. Concentré : no regen adversaire. Perturbé : +4 Base.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_concentre": true, "status_si_perturbe": {"root": 1}}'),
        ("lotus_perception",      "Perception du Flux (Bonus)",    '["moine_lotus"]', 3, 3, 0, 3, 0, "foi", 10, "ferveur", 0, 2, "État de santé réel de tous dans 15m.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Identifie état de santé réel de tous êtres vivants dans 15m (blessures cachées, maladies, poisons)."}'),
        ...
        # P4
        ("lotus_sceau_avance",    "Sceau du Lotus Avancé",         '["moine_lotus"]', 4, 4, 10, 4, 4, "foi", 30, "ferveur", 2, 3, "Soin 22 PV + dissipe tous négatifs. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 22, "concentre_bonus": 5, "cleanse_target": true, "cleanse_all": true}'),
        ("lotus_frappe_eveil_avance","Frappe de l'Éveil Avancée",  '["moine_lotus"]', 4, 4, 10, 5, 3, "foi", 28, "ferveur", 0, 3, "Stun. Concentré : no regen. Perturbé : +4 Base + ignore Armure+Rob.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_concentre": true, "ignore_armor_rob_si_perturbe": true}'),
        ("lotus_transfert_total_novice","Transfert Total Novice",  '["moine_lotus"]', 4, 4, 8, 4, 4, "foi", 35, "ferveur", 2, 4, "Soin 25 PV allié, perd 8 PV. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 25, "concentre_bonus": 5, "self_dmg": 8}'),
        ("lotus_secret",          "Secret du Monastère (Bonus)",   '["moine_lotus"]', 4, 4, 0, 3, 0, "foi", 15, "ferveur", 1, 2, "Connaissance interdite du Temple.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Temple révèle connaissance interdite : org secrète, poison rare, technique oubliée ou maladie incurable."}'),
        ...
        # P5
        ("lotus_frappe_finale",   "Frappe de l'Éveil Finale",      '["moine_lotus"]', 5, 5, 14, 5, 5, "foi", 40, "ferveur", 0, 3, "Dégâts massifs. 3 Hémos. Ignore Armure. Rob cible -3.", "actif", "spe", '{"seuil": 4, "status": {"hemorragie": 3}, "ignore_armor": true, "reduce_rob_cible": 3}'),
        ("lotus_transfert_final", "Transfert Total Avancé",        '["moine_lotus"]', 5, 5, 18, 4, 5, "foi", 50, "ferveur", 4, 4, "Soin 40 PV allié + dissipe tous négatifs, perd 15 PV.", "soin", "spe", '{"seuil": 3, "soin_base": 40, "concentre_bonus": 5, "self_dmg": 15, "cleanse_target": true, "cleanse_all": true}'),
        ("lotus_sceau_final",     "Sceau du Lotus Final",          '["moine_lotus"]', 5, 5, 12, 5, 5, "foi", 45, "ferveur", 3, 4, "Soin 35 PV + dissipe tous + Armure 15 1 tour.", "soin", "spe", '{"seuil": 4, "soin_base": 35, "cleanse_target": true, "cleanse_all": true, "self_status": {"armure": 15}}'),
        ("lotus_noir",            "Lotus Noir (Bonus)",            '["moine_lotus"]', 5, 5, 0, 4, 0, "foi", 35, "ferveur", 3, 6, "Purification profonde d'un traumatisme.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Cible consentante affronte pires regrets. Dissipe effets mentaux permanents, malédictions ou compétences bloquées."}'),
        ...
        # --- ACTIFS ---
        ("hosp_imposition",       "Imposition des Mains",        '["ordre_hospitalier"]', 1, 1, 8, 3, 2, "foi", 15, "ferveur", 0, 2, "Soin ciblé. L'Hospitalier subit 2 dégâts.", "soin", "spe", '{"seuil": 1, "soin_cible": 10, "self_dmg": 2}'),
        ("hosp_bouclier_sacre",   "Bouclier Sacré",               '["ordre_hospitalier"]', 2, 2, 6, 3, 2, "foi", 20, "ferveur", 0, 3, "Pose état Armure 3 sur un allié.", "soin", "spe", '{"seuil": 2, "self_status": {"armure": 3}, "cible_allie": true}'),
        ("hosp_purification",     "Purification Sacrificielle",  '["ordre_hospitalier"]', 3, 3, 9, 4, 3, "foi", 25, "ferveur", 0, 3, "Dissipe toutes les altérations d'un allié. L'Hospitalier en absorbe la moitié.", "soin", "spe", '{"seuil": 2, "cleanse_cible_allie": true, "self_dmg_half_alts": true}'),
        ("hosp_sanctuaire",       "Sanctuaire",                  '["ordre_hospitalier"]', 4, 4, 12, 5, 4, "foi", 35, "ferveur", 0, 4, "Zone de protection : tous les alliés ignorent prochains 5 dégâts.", "soin", "spe", '{"seuil": 3, "armure_allie_aoe": 5}'),
        ("hosp_sacrifice_absolu",  "Sacrifice Absolu",            '["ordre_hospitalier"]', 5, 5, 0, 6, 0, "foi", 50, "ferveur", 0, 6, "L'Hospitalier tombe à 1 PV. Tous les alliés régénèrent 40% de leurs PV max.", "soin", "spe", '{"seuil": 4, "sacrifice_absolu": true}'),
        ...
        # P1
        ("oracle_entrave_novice", "Entrave du Destin Novice",      '["oracle"]', 1, 1, 3, 3, 2, "foi", 10, "ferveur", 0, 2, "Freine le mouvement d'un être.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}}'),
        ("oracle_touche_novice",  "Touche du Destin Novice (Bonus)", '["oracle"]', 1, 1, 0, 3, 0, "foi", 12, "ferveur", 0, 3, "Réduit Base prochain sort cible de Foi÷2.", "utilitaire", "spe", '{"seuil": 2, "reduce_base_cible": "foi_half", "bonus_si_presage_exact": {"reduce_bonus_pieces": 2}}'),
        ...
        ("oracle_frappe_premo_novice","Frappe Prémonitoire Novice",'["oracle"]', 2, 2, 6, 3, 3, "foi", 15, "ferveur", 0, 2, "Dégâts sacrés. Présage exact : +3 Base.", "actif", "spe", '{"seuil": 2, "base_bonus_si_presage": 3}'),
        ("oracle_entrave_avance", "Entrave du Destin Avancée",     '["oracle"]', 2, 2, 5, 4, 2, "foi", 16, "ferveur", 0, 2, "Dégâts sacrés. Enracinement + Étourdissement.", "actif", "spe", '{"seuil": 2, "status": {"root": 1, "stun": 1}}'),
        ("oracle_bassin",         "Bassin des Reflets (Bonus)",    '["oracle"]', 2, 2, 0, 2, 0, "foi", 12, "ferveur", 0, 2, "1 info sur personne/lieu/événement passé.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Dans surface réfléchissante : MJ révèle 1 info sur personne, lieu ou événement passé lié à cet endroit."}'),
        ...
        ("oracle_frappe_premo_avance","Frappe Prémonitoire Avancée",'["oracle"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 2, "Dégâts sacrés. Présage exact : +5 Base + ignore Rob.", "actif", "spe", '{"seuil": 3, "base_bonus_si_presage": 5, "ignore_rob_si_presage": true}'),
        ("oracle_touche_avance",  "Touche du Destin Avancée (Bonus)", '["oracle"]', 3, 3, 0, 4, 0, "foi", 22, "ferveur", 0, 3, "Stun. Présage exact : cible no regen ce tour.", "utilitaire", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_presage": true}'),
        ...
        ("oracle_frappe_noeud",   "Frappe du Nœud",                '["oracle"]', 4, 4, 11, 5, 4, "foi", 30, "ferveur", 0, 3, "Ignore Rob. Présage exact : +5 Base + Stun.", "actif", "spe", '{"seuil": 3, "ignore_rob": true, "base_bonus_si_presage": 5, "status_si_presage": {"stun": 1}}'),
        ("oracle_entrevision",    "Entrevision (Bonus)",           '["oracle"]', 4, 4, 0, 4, 0, "foi", 25, "ferveur", 2, 3, "Scène passée ou future (6h max) liée à objet.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "MJ révèle scène du passé ou futur proche (6h max) liée à personne ou objet. Véridique mais métaphorique."}'),
        ...
        # P5
        ("oracle_noeud_destin",   "Nœud du Destin",                '["oracle"]', 5, 5, 15, 5, 6, "foi", 45, "ferveur", 5, 4, "Dégâts massifs ignorant toute défense. Stun 2 tours.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "status": {"stun": 2}}'),
        ("oracle_deviation_absolue","Déviation Absolue",           '["oracle"]', 5, 5, 0, 5, 0, "foi", 40, "ferveur", 4, 5, "Redirige attaque ciblant allié vers un ennemi.", "defense", "spe", '{"seuil": 4, "redirection_attaque": true}'),
        ("oracle_frappe_noeud_avance","Frappe du Nœud Avancée",    '["oracle"]', 5, 5, 14, 6, 5, "foi", 40, "ferveur", 0, 3, "Ignore toute défense. Présage exact <30% PV : Exécution.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "execute_percent_si_presage": 30}'),
        ("oracle_prophetie",      "Prophétie de l'Ordre (Bonus)",  '["oracle"]', 5, 5, 0, 4, 0, "foi", 60, "ferveur", 6, 6, "Prophétie publique se réalisant dans la session.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Prononcez prophétie publique. MJ garantit réalisation dans cette session ou la suivante."}'),
        ...
        # P1
        ("inq_jugement_novice",   "Jugement Novice",               '["inquisiteur"]', 1, 1, 5, 3, 2, "foi", 12, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : +3 Base + 1 Brûlure.", "actif", "spe", '{"seuil": 2, "bonus_si_condamne": {"base_bonus": 3, "status": {"brulure": 1}}}'),
        ("inq_frappe_novice",     "Frappe d'Inquisition Novice",   '["inquisiteur"]', 1, 1, 4, 3, 2, "foi", 10, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : Enracinement.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"root": 1}}'),
        ("inq_aveu",              "Aveu Forcé (Bonus)",            '["inquisiteur"]', 1, 1, 0, 2, 0, "foi", 8, "ferveur", 0, 2, "Force PNJ à répondre véridiquement.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Force PNJ à répondre véridiquement à 1 question. Pas PJs ni Foi égale/sup."}'),
        ...
        # P2
        ("inq_chatiment_novice",  "Châtiment Novice",              '["inquisiteur"]', 2, 2, 6, 4, 2, "foi", 18, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : Étourdissement.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"stun": 1}}'),
        ("inq_purif",             "Purification Forcée",           '["inquisiteur"]', 2, 2, 0, 3, 0, "foi", 15, "ferveur", 0, 3, "Dissipe tous effets actifs. Si Condamnée : no buff reste combat.", "actif", "spe", '{"seuil": 2, "cleanse_target": true, "cleanse_all": true, "no_buff_si_condamne": true}'),
        ("inq_frappe_avance",     "Frappe d'Inquisition Avancée",  '["inquisiteur"]', 2, 2, 7, 4, 3, "foi", 16, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : Stun + 2 Brûlures.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"stun": 1, "brulure": 2}}'),
        ...
        # P3
        ("inq_jugement_avance",   "Jugement Avancé",               '["inquisiteur"]', 3, 3, 9, 4, 3, "foi", 25, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : 3 Brûlures + Stun.", "actif", "spe", '{"seuil": 3, "status_si_condamne": {"brulure": 3, "stun": 1}}'),
        ("inq_contre_esp_novice", "Contre-Espionnage Novice",      '["inquisiteur"]', 3, 3, 0, 3, 0, "foi", 20, "ferveur", 0, 3, "Révèle invisibles/déguisés dans 50m.", "actif", "spe", '{"seuil": 2, "cleanse_furtif": true, "rp_effect": "Révèle toute personne invisible/déguisée/en filature dans 50m."}'),
        ("inq_chatiment_avance",  "Châtiment Avancé",              '["inquisiteur"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 2, "Dégâts sacrés. Si Condamnée : Stun 2 tours + ignore Rob.", "actif", "spe", '{"seuil": 3, "status_si_condamne": {"stun": 2}, "ignore_rob_si_condamne": true}'),
        ("inq_verite",            "Vérité Absolue (Bonus)",        '["inquisiteur"]', 3, 3, 0, 3, 0, "foi", 20, "ferveur", 2, 3, "Zone 10m où aucun mensonge possible.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Crée zone 10m où aucun mensonge possible pendant 10min. MJ valide réponses."}'),
        ...
        # P4
        ("inq_chatiment_divin",   "Châtiment Divin",               '["inquisiteur"]', 4, 4, 11, 5, 4, "foi", 32, "ferveur", 0, 3, "Dégâts sacrés massifs. Si Condamnée : Stun 2 tours + ignore Armure.", "actif", "spe", '{"seuil": 3, "ignore_armor_si_condamne": true, "status_si_condamne": {"stun": 2}}'),
        ("inq_purif_totale",      "Purification Totale",           '["inquisiteur"]', 4, 4, 0, 4, 0, "foi", 25, "ferveur", 2, 4, "Dissipe TOUT. Si Condamnée : no buff reste combat + résistances.", "actif", "spe", '{"seuil": 3, "cleanse_target": true, "cleanse_all": true, "no_buff_si_condamne": true}'),
        ("inq_contre_esp_avance", "Contre-Espionnage Avancé",      '["inquisiteur"]', 4, 4, 8, 4, 3, "foi", 25, "ferveur", 0, 3, "Révèle et Condamne automatiquement ennemis Furtifs.", "actif", "spe", '{"seuil": 3, "condamne_furtifs": true, "aoe": true}'),
        ("inq_effacement",        "Effacement de Dossier (Bonus)", '["inquisiteur"]', 4, 4, 0, 3, 0, "foi", 20, "ferveur", 2, 3, "Efface identité d'une personne dans une ville.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Efface existence administrative, sociale et criminelle d\'une personne dans une ville. Ne peut cibler PJs."}'),
        ...
        # P5
        ("inq_jugement_final",    "Jugement Final",                '["inquisiteur"]', 5, 5, 18, 6, 6, "foi", 50, "ferveur", 6, 5, "Dégâts sacrés massifs. Condamnée <20% PV : Exécution.", "actif", "spe", '{"seuil": 4, "execute_percent_si_condamne": 20}'),
        ("inq_contre_esp_total",  "Contre-Espionnage Total",       '["inquisiteur"]', 5, 5, 12, 5, 4, "foi", 35, "ferveur", 0, 3, "Zone : dissipe tous Furtifs/illusions. Tous révélés = Condamnés.", "actif", "spe", '{"seuil": 3, "cleanse_furtif": true, "condamne_tous_reveles": true, "aoe": true}'),
        ("inq_chatiment_absolu",  "Châtiment Absolu",              '["inquisiteur"]', 5, 5, 14, 6, 5, "foi", 40, "ferveur", 0, 4, "Ignore toute défense. Condamnée : Stun 2 tours + 5 Brûlures.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "status_si_condamne": {"stun": 2, "brulure": 5}}'),
        ("inq_confession",        "Confession Finale (Bonus)",     '["inquisiteur"]', 5, 5, 0, 6, 0, "foi", 70, "ferveur", 8, 6, "Question absolue — l'univers répond véridiquement.", "utilitaire", "spe", '{"seuil": 4, "rp_effect": "Posez question absolue sur mystère, org ou personne. MJ répond véridiquement et complètement."}'),
