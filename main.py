...
def populate_spells():
    ...
    sorts = [
        ...
        ("nebel_novice", "Nebel Novice", '["mage"]', 1, 1, 2, 4, 2, "esp", 5, "mana", 0, 1, "Nuage toxique.", "actif", "tronc", '{"seuil": 2, "status": {"poison": 2}}'),
        ("schild_novice", "Schild Novice (Bonus)", '["mage"]', 1, 1, 0, 2, 3, "esp", 5, "mana", 0, 1, "Barrière.", "defense", "tronc", '{"seuil": 1, "reduce_dmg_dynamic": true}'),
        ("funke_novice", "Funke Novice", '["mage"]', 1, 1, 3, 3, 2, "esp", 4, "mana", 0, 1, "Étincelle.", "actif", "tronc", '{"status": {"brulure": 1}}'),
        ("kernblitz", "Kernblitz", '["mage"]', 1, 1, 4, 3, 2, "esp", 5, "mana", 0, 1, "Foudre (Hâte).", "actif", "tronc", '{"seuil": 2, "self_status": {"hate": 1}}'),
        ("magia", "Magia (Bonus)", '["mage"]', 1, 1, 0, 2, 0, "esp", 4, "mana", 0, 1, "Détection.", "utilitaire", "tronc", '{"seuil": 2, "rp_effect": "Détecte le type de magie (Déesse/Démon)."}'),
        ("purgato", "Purgato (Bonus)", '["mage"]', 1, 1, 0, 0, 0, "esp", 3, "mana", 0, 1, "Nettoyage.", "utilitaire", "tronc", '{"rp_effect": "Nettoie la zone de 5m."}'),
        ("liber", "Liber (Bonus)", '["mage"]', 1, 1, 0, 0, 0, "esp", 3, "mana", 0, 1, "Analyse.", "utilitaire", "tronc", '{"rp_effect": "Indique l ancienneté (Blanc=neuf, Rouge=vieux)."}'),
        ("fessel", "Fessel", '["mage"]', 1, 1, 6, 3, 2, "esp", 5, "mana", 0, 1, "Enracinement.", "actif", "tronc", '{"seuil": 2, "status": {"root": 1}}'),
        ("ekko", "Ekko (Bonus)", '["mage"]', 1, 1, 0, 0, 0, "esp", 4, "mana", 0, 1, "Vision.", "utilitaire", "tronc", '{"rp_effect": "Vision des 5 dernières secondes de l objet."}'),
        ("siphon", "Siphon", '["mage"]', 1, 1, 3, 3, 2, "esp", 2, "mana", 0, 1, "Drain Mana.", "actif", "tronc", '{"seuil": 1, "restore_mana": 3}'),
        ("flash", "Flash (Bonus)", '["mage"]', 1, 1, 0, 1, 0, "esp", 7, "mana", 0, 1, "TP Esquive.", "defense", "tronc", '{"seuil": 1, "rp_effect": "+7 Esquive (Narratif/Bonus)."}'),

        # P2 (+2 Base, +1 Pièce)
        ("zooltrak", "Zooltrak", '["mage"]', 2, 2, 10, 3, 3, "esp", 8, "mana", 0, 0, "Rayon moyen.", "actif", "tronc", "{}"),
        ("schwer", "Schwer", '["mage"]', 2, 2, 6, 4, 2, "esp", 9, "mana", 0, 1, "Gravité.", "actif", "tronc", '{"seuil": 2, "status": {"stun": 1}}'),
        ("hagel", "Hagel", '["mage"]', 2, 2, 6, 6, 1, "esp", 8, "mana", 0, 1, "Grêle.", "actif", "tronc", '{"seuil": 3, "ricochet": true}'),
        ("eis", "Eis", '["mage"]', 2, 2, 8, 4, 2, "esp", 7, "mana", 0, 1, "Gel.", "actif", "tronc", '{"status": {"gel": 1}}'),
        ("hand", "Hand (Bonus)", '["mage"]', 2, 2, 0, 1, 0, "esp", 5, "mana", 0, 1, "Main.", "utilitaire", "tronc", '{"rp_effect": "Manipule objet 5kg/10m."}'),
        ("stimme", "Stimme (Bonus)", '["mage"]', 2, 2, 0, 2, 0, "esp", 3, "mana", 0, 1, "Voix.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Avantage sur jet Oral."}'),

        # P3 (+3 Base, +1 Pièce)
        ("schild_normal", "Schild (Bonus)", '["mage"]', 3, 3, 5, 3, 4, "esp", 10, "mana", 0, 1, "Bouclier Zone.", "defense", "tronc", '{"seuil": 2, "reduce_dmg_dynamic": true, "rp_effect": "Protège aussi un allié adjacent."}'),
        ("funke", "Funke", '["mage"]', 3, 3, 11, 3, 2, "esp", 12, "mana", 0, 1, "Grosse étincelle.", "actif", "tronc", '{"status": {"brulure": 3}}'),
        ("nebel", "Nebel", '["mage"]', 3, 3, 9, 4, 3, "esp", 12, "mana", 0, 2, "Brouillard.", "actif", "tronc", '{"status": {"poison": 3}}'),
        ("feder", "Feder (Bonus)", '["mage"]', 3, 3, 0, 1, 0, "esp", 5, "mana", 0, 1, "Poids plume.", "utilitaire", "tronc", "{}"),
        ("schloss", "Schloss (Bonus)", '["mage"]', 3, 3, 0, 2, 0, "esp", 6, "mana", 0, 1, "Serrure.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Ouvre/Ferme serrure magiquement."}'),
        ("fliegen", "Fliegen (Bonus)", '["mage"]', 3, 3, 0, 1, 0, "esp", 8, "mana", 0, 1, "Vol.", "utilitaire", "tronc", '{"rp_effect": "Vol 10min."}'),
        ("klinge", "Klinge", '["mage"]', 3, 3, 7, 5, 3, "esp", 11, "mana", 0, 1, "Lame vent.", "actif", "tronc", '{"seuil": 2, "status": {"hemorragie": 3}}'),
        ("golem", "Golem (Bonus)", '["mage"]', 3, 3, 3, 3, 0, "esp", 15, "mana", 0, 3, "Invocation.", "actif", "tronc", '{"seuil": 1, "summon": "golem", "rp_effect": "Golem 20 PV actif."}'),

        # P4 (+4 Base, +1 Pièce)
        ("zooltrak_avance", "Zooltrak Avancé", '["mage"]', 4, 4, 16, 3, 7, "esp", 18, "mana", 0, 0, "Perce-Défense.", "actif", "tronc", '{"ignore_armor": true}'),
        ("donner", "Donner", '["mage"]', 4, 4, 12, 5, 4, "esp", 16, "mana", 0, 1, "Tonnerre.", "actif", "tronc", '{"seuil": 3, "status": {"stun": 1}, "ricochet": true}'),
        ("vulkan", "Vulkan", '["mage"]', 4, 4, 14, 4, 6, "esp", 20, "mana", 0, 2, "Éruption.", "actif", "tronc", '{"seuil": 1, "status": {"brulure": 4}}'),
        ("teleport", "Teleport (Bonus)", '["mage"]', 4, 4, 0, 1, 0, "esp", 25, "mana", 0, 3, "Téléportation.", "utilitaire", "tronc", '{"rp_effect": "Voyage instantané ou Fuite auto."}'),
        ("spiegel", "Spiegel", '["mage"]', 4, 4, 4, 3, 0, "esp", 15, "mana", 0, 2, "Miroir.", "defense", "tronc", '{"seuil": 1, "rp_effect": "Annule la prochaine attaque (Clone)."}'),
        ("analyse", "Analyse (Bonus)", '["mage"]', 4, 4, 0, 2, 0, "esp", 12, "mana", 0, 0, "Scan.", "utilitaire", "tronc", '{"rp_effect": "Révèle PV, Faiblesses et Résistances."}'),

        # P5 (+5 Base, +1 Pièce)
        ("schild_avance_mage", "Schild Avancé (Bonus)", '["mage"]', 5, 5, 12, 2, 6, "esp", 22, "mana", 0, 1, "Forteresse.", "defense", "tronc", '{"seuil": 1, "reduce_dmg_dynamic": true, "reflect_dmg_percent": 50, "rp_effect": "Renvoie 50pourcent des dégâts."}'),
        ("funke_avance", "Funke Avancé", '["mage"]', 5, 5, 19, 3, 5, "esp", 24, "mana", 0, 1, "Orage.", "actif", "tronc", '{"status": {"brulure": 5}}'),
        ("nebel_avance", "Nebel Avancé", '["mage"]', 5, 5, 17, 4, 4, "esp", 23, "mana", 0, 1, "Nuage Gigantesque.", "actif", "tronc", '{"status": {"poison": 3}, "aoe": true}'),
        ("meteor", "Meteor", '["mage"]', 5, 5, 25, 4, 10, "esp", 40, "mana", 0, 2, "Météore.", "actif", "tronc", '{"seuil": 2, "aoe": true, "terrain_destruct": true}'),
        ("schwarzes_loch", "Schwarzes Loch", '["mage"]', 5, 5, 20, 6, 5, "esp", 30, "mana", 0, 3, "Trou Noir.", "actif", "tronc", '{"seuil": 4, "execute_flat": 30}'),
        ("jigoku", "Jigoku", '["mage"]', 5, 5, 17, 5, 6, "esp", 30, "mana", 0, 1, "Tempête Feu.", "actif", "tronc", '{"status": {"brulure": 4}, "status_cumul": true}'),
        ("judrajim", "Judrajim", '["mage"]', 5, 5, 25, 6, 5, "esp", 45, "mana", 0, 3, "Ruine.", "actif", "tronc", '{"status": {"stun": 1}, "ricochet": true}'),
        ...
        ("schnitt_novice", "Schnitt Novice", '["guerrier"]', 1, 1, 4, 4, 1, "phy", 1, "tension", 0, 1, "Une entaille vicieuse visant une zone non protégée.", "actif", "tronc", '{"seuil": 1, "status": {"hemorragie": 2}}'),
        ("fegen_novice", "Fegen Novice", '["guerrier"]', 1, 1, 3, 4, 3, "phy", 1, "tension", 0, 1, "Un balayage bas visant les jambes pour faire chuter.", "actif", "tronc", '{"seuil": 2, "status": {"root": 1}}'),
        ("zorn_novice", "Zorn Novice", '["guerrier"]', 1, 1, 5, 4, 4, "phy", 1, "tension", 0, 1, "Une frappe alimentée par la colère.", "actif", "tronc", '{"self_damage": 5}'),
        ("hieb", "Hieb", '["guerrier"]', 1, 1, 5, 4, 1, "phy", 0, "tension", 0, 1, "Un coup d'arme brutal, parfait pour tester la garde adverse.", "actif", "tronc", '{"seuil": 1, "generate_tension": 1}'),
        ("stoss", "Stoss", '["guerrier"]', 1, 1, 6, 4, 2, "phy", 1, "tension", 0, 1, "Une frappe d'estoc directe et ultra-rapide conçue pour percer.", "actif", "tronc", '{"guaranteed_dmg": 5}'),
        ("atem", "Atem (Bonus)", '["guerrier"]', 1, 1, 0, 1, 0, "phy", 1, "tension", 0, 1, "Une technique de respiration pour ignorer la douleur.", "defense", "tronc", '{"seuil": 1, "reduce_dmg_flat": 4}'),
        ("instinkt", "Instinkt (Bonus)", '["guerrier"]', 1, 1, 0, 3, 0, "phy", 1, "tension", 0, 1, "Les sens s'aiguisent pour repérer le danger immédiat.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Détecte embuscade, piège ou ennemi caché."}'),
        ("blick", "Blick (Bonus)", '["guerrier"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 1, "Un simple regard noir.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Force un PNJ civil ou lâche à révéler une information sans avoir besoin de le frapper."}'),
        ...
        ("ansturm", "Ansturm", '["guerrier"]', 2, 2, 7, 5, 2, "phy", 2, "tension", 0, 1, "Une charge où le guerrier se jette pour renverser l'ennemi.", "actif", "tronc", '{"seuil": 2, "status": {"stun": 1}}'),
        ("spalten", "Spalten", '["guerrier"]', 2, 2, 8, 4, 4, "phy", 2, "tension", 0, 2, "Un coup vertical dévastateur conçu pour fendre les boucliers et les armures.", "actif", "tronc", '{"guaranteed_dmg": 5, "status": {"hemorragie": 1}}'),
        ("wille", "Wille (Bonus)", '["guerrier"]', 2, 2, 0, 2, 0, "phy", 1, "tension", 0, 1, "Un effort mental pour rejeter une affliction.", "utilitaire", "tronc", '{"seuil": 1, "cleanse_self": true}'),
        ("wut", "Wut (Bonus)", '["guerrier"]', 2, 2, 0, 2, 0, "phy", 0, "tension", 0, 3, "Laisse la rage prendre le dessus pour ignorer la fatigue.", "utilitaire", "tronc", '{"seuil": 1, "generate_tension": 3, "self_damage": 10}'),
        ("gehor", "Gehör (Bonus)", '["guerrier"]', 2, 2, 0, 2, 0, "phy", 0, "tension", 0, 1, "Une concentration absolue sur les bruits environnants.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Permet d\'entendre à travers les murs épais ou de repérer des ennemis invisibles."}'),

        # PALLIER 3
        ("schnitt_normal", "Schnitt", '["guerrier"]', 3, 3, 6, 6, 2, "phy", 2, "tension", 0, 1, "L'entaille devient béante, tranchant profondément la chair.", "actif", "tronc", '{"seuil": 2, "status": {"hemorragie": 3}}'),
        ("fegen_normal", "Fegen", '["guerrier"]', 3, 3, 5, 5, 4, "phy", 2, "tension", 0, 1, "Un fauchage brisant les appuis de la cible.", "actif", "tronc", '{"seuil": 2, "status": {"root": 1}, "bonus_vs_status": "root", "bonus_val": 5}'),
        ("zorn_normal", "Zorn", '["guerrier"]', 3, 3, 8, 5, 4, "phy", 2, "tension", 0, 1, "Une attaque aveugle avec une force démesurée.", "actif", "tronc", '{"self_damage": 8}'),
        ("wirbelwind", "Wirbelwind", '["guerrier"]', 3, 3, 8, 6, 2, "phy", 2, "tension", 0, 1, "Une rotation meurtrière balayant tout autour du guerrier.", "actif", "tronc", '{"seuil": 2, "aoe": true}'),
        ("knochenbrecher", "Knochenbrecher", '["guerrier"]', 3, 3, 9, 6, 4, "phy", 2, "tension", 0, 2, "Une frappe écrasante visant à briser les os.", "actif", "tronc", '{"seuil": 3, "status": {"mutilation": 1}}'),
        ("schleifen", "Schleifen (Bonus)", '["guerrier"]', 3, 3, 0, 2, 0, "phy", 1, "tension", 0, 1, "Prend un instant pour aiguiser sa lame.", "utilitaire", "tronc", '{"seuil": 1, "self_status": {"dmg_boost": 5}}'),
        ("drohung", "Drohung (Bonus)", '["guerrier"]', 3, 3, 0, 2, 0, "phy", 1, "tension", 0, 1, "Une posture ou un cri de guerre si terrifiant qu'il paralyse.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Confère un Avantage majeur sur un jet d\'Intimidation de masse ou dissipe une émeute."}'),
        ("tragen", "Tragen (Bonus)", '["guerrier"]', 3, 3, 0, 1, 0, "phy", 1, "tension", 0, 1, "Déploie une force herculéenne momentanée.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Permet de soulever une charge impossible comme un rocher ou une herse."}'),
        ...
        ("hinrichten", "Hinrichten", '["guerrier"]', 4, 4, 12, 7, 5, "phy", 3, "tension", 0, 2, "Le coup de grâce, réservé aux ennemis brisés.", "actif", "tronc", '{"seuil": 4, "execute_percent": 25}'),
        ("erdbeben", "Erdbeben", '["guerrier"]', 4, 4, 10, 7, 4, "phy", 3, "tension", 0, 2, "Frappe le sol avec une telle puissance que la terre se fracture.", "actif", "tronc", '{"seuil": 3, "aoe": true, "terrain_destruct": true}'),
        ("eiserner_wille", "Eiserner Wille (Bonus)", '["guerrier"]', 4, 4, 0, 2, 0, "phy", 2, "tension", 0, 3, "Une détermination d'acier qui repousse les intrusions mentales.", "utilitaire", "tronc", '{"seuil": 1, "cleanse_self": true, "rp_effect": "Purge instantanément tous les contrôles (Étourdissement, Enracinement, Sommeil, Gel) sur soi-même."}'),
        ("sprung", "Sprung (Bonus)", '["guerrier"]', 4, 4, 0, 2, 0, "phy", 1, "tension", 0, 1, "Un saut surhumain.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Permet de bondir par-dessus un ravin de 15 mètres ou d\'atteindre le sommet d\'un batiment."}'),
        ("uberleben", "Überleben (Bonus)", '["guerrier"]', 4, 4, 0, 2, 0, "phy", 0, "tension", 0, 1, "Un instinct de survie forgé dans les pires conditions.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Permet de survivre nu dans un blizzard, de digérer du poison naturel ou de résister à la soif."}'),

        # PALLIER 5
        ("schnitt_avance", "Schnitt Avancé", '["guerrier"]', 5, 5, 9, 8, 3, "phy", 3, "tension", 0, 1, "L'air lui-même semble trancher la chair (Stade 3).", "actif", "tronc", '{"seuil": 3, "status": {"hemorragie": 5}}'),
        ("fegen_avance", "Fegen Avancé", '["guerrier"]', 5, 5, 8, 8, 5, "phy", 3, "tension", 0, 1, "Une onde de choc au sol brisant les jambes (Stade 3).", "actif", "tronc", '{"seuil": 3, "status": {"root": 1}, "aoe": true}'),
        ("zorn_avance", "Zorn Avancé", '["guerrier"]', 5, 5, 12, 8, 6, "phy", 3, "tension", 0, 1, "La colère d'un dieu de la guerre (Stade 3).", "actif", "tronc", '{"self_damage": 12, "ignore_armor": true}'),
        ("kometenschlag", "Kometenschlag", '["guerrier"]', 5, 5, 16, 8, 6, "phy", 4, "tension", 0, 2, "Un saut prodigieux suivi d'un impact météoritique.", "actif", "tronc", '{"seuil": 4, "aoe": true, "terrain_destruct": true}'),
        ("verwustung", "Verwüstung", '["guerrier"]', 5, 5, 14, 8, 5, "phy", 3, "tension", 0, 2, "Un déluge ininterrompu de frappes d'une lourdeur effroyable.", "actif", "tronc", '{"seuil": 4, "ricochet": true}'),
        ("unsterblich", "Unsterblich (Bonus)", '["guerrier"]', 5, 5, 0, 1, 0, "phy", 4, "tension", 0, 5, "Le refus catégorique de mourir.", "defense", "tronc", '{"seuil": 1, "self_status": {"unsterblich": 9999}, "rp_effect": "Vous donne la marque de l’indomptable : Si une attaque doit vous mettre ko, vous restez à 1 PV."}'),
        ...
        ("titanenblut", "Titanenblut (Bonus)", '["guerrier"]', 5, 5, 0, 2, 0, "phy", 3, "tension", 0, 3, "Le sang bout et les muscles se gonflent de manière inhumaine.", "utilitaire", "tronc", '{"seuil": 1, "self_status": {"titanenblut": 3}, "rp_effect": "Pendant 3 tours, vous gagnez 10pv par tour et toutes vos attaque gagne une pièce."}'),
        ...
        ("segnung", "Segnung (Bonus)", '["pretre"]', 1, 1, 0, 1, 0, "foi", 10, "ferveur", 0, 1, "Purifie les vivres.", "utilitaire", "tronc", '{"rp_effect": "Purifie l eau et la nourriture."}'),
        ("zuflucht", "Zuflucht (Bonus)", '["pretre"]', 1, 1, 0, 1, 0, "foi", 15, "ferveur", 2, 2, "Sanctuaire divin absolu (Coûte 2 Versets).", "defense", "tronc", '{"rp_effect": "Inciblable et invulnérable jusqu au prochain tour."}'),

        # PALLIER 2 (Coût: 2)
        ("lumiere_divine_2", "Lumière Divine Évoluée", '["pretre"]', 2, 2, 6, 4, 2, "foi", 15, "ferveur", 0, 0, "Le rayon gagne en intensité.", "actif", "tronc", "{}"),
        ("heilige_aura_novice", "Heilige Aura Novice", '["pretre"]', 2, 2, 6, 3, 3, "foi", 20, "ferveur", 0, 1, "Onde d énergie purificatrice.", "actif", "tronc", '{"seuil": 1, "aoe": true}'),
        ("lichtstrahl", "Lichtstrahl", '["pretre"]', 2, 2, 9, 4, 2, "foi", 15, "ferveur", 0, 1, "Rayon de lumière aveuglant.", "actif", "tronc", '{"seuil": 2, "status": {"brulure": 2}}'),
        ("zorn_gottes", "Zorn Gottes", '["pretre"]', 2, 2, 14, 4, 3, "foi", 25, "ferveur", 3, 2, "Éclair du ciel étourdissant (Coûte 3 Versets).", "actif", "tronc", '{"seuil": 2, "status": {"stun": 2}}'),
        ("vision", "Vision (Bonus)", '["pretre"]', 2, 2, 0, 2, 0, "foi", 10, "ferveur", 0, 1, "Vision véritable.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Permet de voir les entités invisibles ou illusions."}'),
        ("stimme_gottes", "Stimme Gottes (Bonus)", '["pretre"]', 2, 2, 0, 2, 0, "foi", 10, "ferveur", 0, 1, "Autorité divine.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Force un groupe de PNJ à cesser le combat."}'),
        ("wunder", "Wunder (Bonus)", '["pretre"]', 2, 2, 0, 2, 0, "foi", 20, "ferveur", 3, 3, "Miracle mineur (Coûte 3 Versets).", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Altère légèrement la réalité (réparer, ouvrir, etc.)."}'),
        ...
        ("heiliger_boden", "Heiliger Boden (Bonus)", '["pretre"]', 3, 3, 0, 2, 0, "foi", 15, "ferveur", 0, 2, "Zone anti-affliction.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Dissipe les effets sur vous et vos alliés. (À retirer manuellement avec /retire_effet)"}'),
        ("erweckung", "Erweckung (Bonus)", '["pretre"]', 3, 3, 15, 3, 5, "foi", 30, "ferveur", 5, 3, "Donnez la force de combattre a un allié KO (Coûte 5 Versets).", "soin", "tronc", '{"seuil": 1, "rp_effect": "Réveille instantanément un allié tombé à 0 PV. (Ajustez les PV manuellement via /set_stat)"}'),

        # PALLIER 4 (Coût: 4)
        ("lumiere_divine_3", "Lumière Divine Avancée", '["pretre"]', 4, 4, 10, 5, 3, "foi", 25, "ferveur", 0, 0, "Pilier de lumière écrasant.", "actif", "tronc", "{}"),
        ("heilige_aura_normal", "Heilige Aura", '["pretre"]', 4, 4, 10, 4, 4, "foi", 30, "ferveur", 0, 1, "Explosion purificatrice totale.", "actif", "tronc", '{"seuil": 2, "aoe": true, "cleanse_self": true}'),
        ("licht_nova", "Licht Nova", '["pretre"]', 4, 4, 13, 5, 3, "foi", 25, "ferveur", 0, 1, "Onde de choc lumineuse.", "actif", "tronc", '{"seuil": 2, "aoe": true}'),
        ("judgement", "Judgement", '["pretre"]', 4, 4, 25, 5, 6, "foi", 40, "ferveur", 7, 3, "Épée sacrée géante (Coûte 7 Versets).", "actif", "tronc", '{"seuil": 3, "execute_percent": 20}'),
        ("glaubensprufung", "Glaubensprüfung (Bonus)", '["pretre"]', 4, 4, 0, 2, 0, "foi", 20, "ferveur", 0, 1, "Sonde l âme de la cible.", "utilitaire", "tronc", '{"seuil": 1, "rp_effect": "Dévoile alignement, péchés et peurs d un PNJ."}'),
        ("himmelswache", "Himmelswache (Bonus)", '["pretre"]', 4, 4, 0, 3, 0, "foi", 25, "ferveur", 0, 1, "Invoque un gardien spirituel.", "utilitaire", "tronc", '{"seuil": 2, "rp_effect": "Avatar d énergie montant la garde pendant 1h."}'),
        ("unantastbar", "Unantastbar (Bonus)", '["pretre"]', 4, 4, 0, 2, 0, "foi", 35, "ferveur", 6, 4, "Invulnérabilité divine (Coûte 6 Versets).", "defense", "tronc", '{"self_status": {"unsterblich": 1}}'),

        # PALLIER 5 (Coût: 5)
        ("heilung_avance", "Heilung Avancé", '["pretre"]', 5, 5, 16, 5, 4, "foi", 35, "ferveur", 0, 1, "Guérit toutes les blessures de la zone.", "soin", "tronc", '{"seuil": 2, "aoe": true, "cleanse_target": true}'),
        ("bann_avance", "Bann Avancé", '["pretre"]', 5, 5, 12, 5, 4, "foi", 30, "ferveur", 0, 1, "Fige totalement le champ de bataille.", "actif", "tronc", '{"seuil": 2, "aoe": true, "status": {"stun": 1}}'),
        ("schild_avance_pretre", "Schild Avancé (Bonus)", '["pretre"]', 5, 5, 12, 3, 6, "foi", 35, "ferveur", 0, 1, "Protection absolue de la déesse.", "defense", "tronc", '{"seuil": 1, "reduce_dmg_dynamic": true, "reflect_dmg_percent": 50}'),
        ("sonnensturm", "Sonnensturm", '["pretre"]', 5, 5, 18, 6, 4, "foi", 40, "ferveur", 0, 2, "Tempête de flammes solaires.", "actif", "tronc", '{"seuil": 3, "aoe": true, "status": {"brulure": 5}}'),
        ("mirai", "Mirai (Bonus)", '["pretre"]', 5, 5, 0, 1, 0, "foi", 70, "ferveur", 8, 4, "Maîtrise du temps (Coûte 8 Versets).", "soin", "tronc", '{"rp_effect": "Un allié choisi doit faire la commande /repos."}'),
        ...
        ("wiederauferstehung", "Wiederauferstehung (Bonus)", '["pretre"]', 5, 5, 0, 2, 0, "foi", 80, "ferveur", 8, 10, "Le pouvoir ultime sur la mort (Coûte 8 Versets).", "soin", "tronc", '{"seuil": 1, "rp_effect": "Ramène à la vie un allié mort il y a une heure ou moins. (Restituer ses PV manuellement avec /set_stat)"}'),
        ...
        # --- PALLIER 2 ---
        ("sang_broderie_novice",  "Broderie Macabre Novice",      '["magie_sang"]', 2, 2, 5, 4, 2, "esp", 8, "mana", 0, 1,  "Tisse des fils de sang pour ligoter l'ennemi.", "actif", "spe",   '{"generate_festin": 6, "no_dmg_unless_stade3": true, "seuil": 2, "status": {"root": 2}}'),
        ("sang_baiser_novice",    "Baiser du Vampire Novice",     '["magie_sang"]', 2, 2, 0, 3, 3, "esp", 8, "mana", 0, 2,  "Morsure vampirique qui draine la vie.", "actif", "spe",    '{"generate_festin": 6, "no_dmg_unless_stade3": true, "seuil": 1, "lifesteal_flat": 6}'),
        ("sang_tenue",            "Tenue de Soirée (Bonus)",      '["magie_sang"]', 2, 2, 0, 2, 0, "esp", 6, "mana", 0, 1,  "Illusion de noblesse vampirique.", "utilitaire", "spe",  '{"generate_festin": 5, "rp_effect": "Avantage sur les jets d\'Oral et de Discrétion pendant 1 scène."}'),
        ...
        ("sang_encre",            "Sang d'Encre (Bonus)",         '["magie_sang"]', 2, 2, 0, 2, 0, "esp", 6, "mana", 0, 1,  "Projette un nuage d'encre sanguine aveuglant.", "utilitaire", "spe",  '{"generate_festin": 5, "seuil": 1, "rp_effect": "Aveugle les ennemis dans un cône de 5m pendant 1 tour."}'),
        ...
        # --- PALLIER 5 ---
        ("sang_ciseaux_avance",   "Ciseaux de Sang Avancé",       '["magie_sang"]', 5, 5, 18, 4, 5, "esp", 24, "mana", 0, 2,  "La forme ultime : une volée de lames inévitables.", "actif", "spe",  '{"generate_festin": 10, "no_dmg_unless_stade3": true, "seuil": 1, "status": {"hemorragie": 4}, "aoe": true}'),
        ("sang_ombrelle_avance",  "Ombrelle Écarlate Avancée (Bonus)",'["magie_sang"]',5, 5, 0, 3, 4, "esp", 22, "mana", 0, 2, "Forteresse de sang impénétrable.", "defense", "spe", '{"generate_festin": 10, "seuil": 2, "reduce_dmg_dynamic": true, "reflect_dmg_percent": 50}'),
        ("sang_siphon_avance",    "Siphon Aristocratique Avancé", '["magie_sang"]', 5, 5, 15, 5, 4, "esp", 28, "mana", 0, 2,  "Drain total : vide la cible de son essence vitale.", "actif", "spe",   '{"generate_festin": 10, "no_dmg_unless_stade3": true, "seuil": 2, "lifesteal_flat": 20, "restore_mana": 10}'),
        ("sang_carnaval",         "L'Heure du Carnaval (Bonus)",  '["magie_sang"]', 5, 5, 0, 3, 0, "esp", 20, "mana", 0, 4,  "Transformation en Seigneur Vampire : forme ultime.", "utilitaire", "spe",  '{"generate_festin": 10, "seuil": 2, "self_status": {"mode_sang": 3}, "rp_effect": "Transformation 3 tours : toutes les dépenses de Mana sont payées en PV, dégâts vampiriques doublés."}'),
        ("sang_miroir",           "Miroir de Sang (Bonus)",       '["magie_sang"]', 5, 5, 0, 2, 0, "esp", 18, "mana", 0, 3,  "Crée un double de sang qui absorbe une attaque.", "defense", "spe",  '{"generate_festin": 9, "seuil": 1, "rp_effect": "Annule la prochaine attaque reçue (Clone de sang)."}'),
        ...
        # --- PALLIER 1 ---
        ("elem_flammes_novice",   "Jet de Flammes Novice",         '["magie_elementaire"]', 1, 1, 5, 3, 2, "esp", 5, "mana", 0, 1,  "Projette un jet de feu concentré.", "actif", "spe",  '{"generate_charge": "feu", "status": {"brulure": 1}}'),
        ("elem_souffle_novice",   "Souffle Hivernal Novice (Bonus)",'["magie_elementaire"]', 1, 1, 0, 2, 2, "esp", 5, "mana", 0, 1,  "Souffle d'air glacé ralentissant.", "defense", "spe", '{"generate_charge": "glace", "seuil": 1, "status": {"root": 1}}'),
        ("elem_etincelle_novice", "Étincelle Statique Novice",     '["magie_elementaire"]', 1, 1, 4, 3, 2, "esp", 4, "mana", 0, 1,  "Décharge électrostatique rapide.", "actif", "spe",  '{"generate_charge": "foudre", "seuil": 2, "self_status": {"hate": 1}}'),
        ("elem_allumeur",         "Allume-Feu (Bonus)",            '["magie_elementaire"]', 1, 1, 0, 1, 0, "esp", 3, "mana", 0, 0,  "Maîtrise élémentaire basique.", "utilitaire", "spe", '{"generate_charge": "feu", "rp_effect": "Allume ou éteint des flammes dans un rayon de 5m."}'),
        ...
        # --- PALLIER 2 ---
        ("elem_lance_glace_novice","Lance de Glace Novice",        '["magie_elementaire"]', 2, 2, 6, 4, 2, "esp", 7, "mana", 0, 1,  "Projette un pic de glace acéré.", "actif", "spe",  '{"generate_charge": "glace", "status": {"gel": 1}}'),
        ("elem_bourrasque_novice","Bourrasque Novice (Bonus)",      '["magie_elementaire"]', 2, 2, 0, 3, 2, "esp", 6, "mana", 0, 1,  "Rafale de vent tranchante.", "actif", "spe",  '{"generate_charge": "air", "seuil": 2, "status": {"root": 1}}'),
        ("elem_thermostat",       "Thermostat (Bonus)",            '["magie_elementaire"]', 2, 2, 0, 1, 0, "esp", 4, "mana", 0, 0,  "Régule la température ambiante.", "utilitaire", "spe",  '{"generate_charge": "feu", "rp_effect": "Chauffe ou refroidit une zone de 10m. Utile contre froid extrême/chaleur."}'),
        ("elem_appel_foudre",     "Appel de la Foudre (Bonus)",    '["magie_elementaire"]', 2, 2, 0, 2, 0, "esp", 6, "mana", 0, 1,  "Attire la foudre sur une cible métallique.", "utilitaire", "spe",  '{"generate_charge": "foudre", "seuil": 1, "rp_effect": "Cible portant métal subit désavantage sur ses jets ce tour."}'),
        ("elem_cristallisation",  "Cristallisation (Bonus)",       '["magie_elementaire"]', 2, 2, 0, 2, 0, "esp", 6, "mana", 0, 1,  "Fige un liquide ou une surface.", "utilitaire", "spe",  '{"generate_charge": "glace", "seuil": 1, "rp_effect": "Cristallise un liquide ou surface humide dans 3m. Crée terrain glissant."}'),

        # --- PALLIER 3 ---
        ("elem_flammes",          "Jet de Flammes",                '["magie_elementaire"]', 3, 3, 10, 3, 3, "esp", 12, "mana", 0, 1,  "Jet de flammes intense et dévastateur.", "actif", "spe",  '{"generate_charge": "feu", "status": {"brulure": 3}}'),
        ("elem_lance_glace",      "Lance de Glace",                '["magie_elementaire"]', 3, 3, 9, 4, 3, "esp", 11, "mana", 0, 1,  "Lance de glace solide et perforante.", "actif", "spe",  '{"generate_charge": "glace", "seuil": 1, "status": {"gel": 1}, "guaranteed_dmg": 8}'),
        ("elem_eclair",           "Éclair de Choc",                '["magie_elementaire"]', 3, 3, 8, 4, 2, "esp", 10, "mana", 0, 1,  "Éclair de foudre paralysant.", "actif", "spe",  '{"generate_charge": "foudre", "seuil": 2, "status": {"stun": 1}}'),
        ("elem_vision_chaleur",   "Vision de Chaleur (Bonus)",     '["magie_elementaire"]', 3, 3, 0, 2, 0, "esp", 8, "mana", 0, 0,  "Vision thermique élémentaire.", "utilitaire", "spe",  '{"generate_charge": "feu", "rp_effect": "Vision thermique pendant 10min : détecte êtres vivants et pièges thermiques."}'),
        ("elem_mur_vent",         "Mur de Vent (Bonus)",           '["magie_elementaire"]', 3, 3, 0, 3, 3, "esp", 10, "mana", 0, 2,  "Crée un mur d'air protecteur.", "defense", "spe",  '{"generate_charge": "air", "seuil": 1, "reduce_dmg_flat": 8, "rp_effect": "Dévie projectiles et attaques à distance."}'),

        # --- PALLIER 4 ---
        ("elem_bourrasque",       "Bourrasque",                    '["magie_elementaire"]', 4, 4, 12, 5, 3, "esp", 16, "mana", 0, 1,  "Rafale déchaînée qui projette les ennemis.", "actif", "spe",  '{"generate_charge": "air", "seuil": 2, "status": {"stun": 1}, "aoe": true}'),
        ("elem_supernova",        "Supernova",                     '["magie_elementaire"]', 4, 4, 16, 4, 5, "esp", 20, "mana", 0, 2,  "Explosion ardente consumant tout autour.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 2, "status": {"brulure": 4}, "aoe": true}'),
        ("elem_coeur_givre",      "Cœur de Givre (Bonus)",         '["magie_elementaire"]', 4, 4, 0, 3, 0, "esp", 14, "mana", 0, 2,  "Noyau de glace qui ralentit toute la zone.", "utilitaire", "spe",  '{"generate_charge": "glace", "seuil": 2, "rp_effect": "Réduit l\'initiative de tous les ennemis de -3 pendant 2 tours."}'),
        ("elem_transmutation",    "Transmutation Élémentaire (Bonus)",'["magie_elementaire"]',4, 4, 0, 2, 0, "esp", 12, "mana", 0, 2, "Convertit un élément en un autre.", "utilitaire", "spe",  '{"consume_charges": true, "rp_effect": "Échange le type de TOUTES vos charges actuelles contre un élément au choix."}'),
        ("elem_decharge",         "Décharge (Bonus)",              '["magie_elementaire"]', 4, 4, 0, 2, 0, "esp", 8, "mana", 0, 2,  "Libère toutes les charges pour doubler les pièces du prochain sort.", "utilitaire", "spe",  '{"consume_charges": true, "is_decharge": true, "self_status": {"decharge_active": 1}}'),

        # --- PALLIER 5 ---
        ("elem_tempete",          "Tempête Apocalyptique",         '["magie_elementaire"]', 5, 5, 20, 5, 6, "esp", 35, "mana", 0, 3,  "Déchaîne les 4 éléments simultanément.", "actif", "spe",  '{"generate_charge": "foudre", "generate_charge_2": "air", "seuil": 3, "aoe": true, "status": {"stun": 1}}'),
        ("elem_zenith",           "Zénith Solaire (Bonus)",        '["magie_elementaire"]', 5, 5, 0, 3, 0, "esp", 30, "mana", 0, 4,  "Invoque le soleil pour brûler la zone.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 2, "status": {"brulure": 5}, "aoe": true}'),
        ("elem_prison_cristal",   "Prison de Cristal",             '["magie_elementaire"]', 5, 5, 18, 5, 4, "esp", 32, "mana", 0, 3,  "Emprisonne la cible dans un cristal de glace massif.", "actif", "spe",  '{"generate_charge": "glace", "seuil": 3, "status": {"stun": 2}, "ignore_armor": true}'),
        ("elem_vol",              "Vol Élémentaire (Bonus)",       '["magie_elementaire"]', 5, 5, 0, 2, 0, "esp", 20, "mana", 0, 0,  "Chevauche les courants élémentaires.", "utilitaire", "spe",  '{"generate_charge": "air", "rp_effect": "Vol libre pendant 30min sur courants d\'air. Vitesse doublée."}'),
        ("elem_eruption",         "Éruption Primordiale",          '["magie_elementaire"]', 5, 5, 25, 5, 8, "esp", 45, "mana", 0, 4,  "L'explosion élémentaire ultime.", "actif", "spe",  '{"generate_charge": "feu", "seuil": 3, "aoe": true, "status": {"brulure": 5}, "execute_percent": 15}'),
        ...
        # P1
        ("grav_traction_novice",  "Traction Novice",               '["magie_gravitationnelle"]', 1, 1, 0, 3, 0, "esp", 4, "mana", 0, 1, "Filament de mana intensifiant la pesanteur locale.", "actif", "spe", '{"generate_lestage": 2, "seuil": 1}'),
        ("grav_onde_novice",      "Onde Répulsive Novice",         '["magie_gravitationnelle"]', 1, 1, 4, 3, 2, "esp", 5, "mana", 0, 1, "Inverse brutalement la pesanteur.", "actif", "spe", '{"generate_lestage": 1, "seuil": 2}'),
        ("grav_pression_novice",  "Pression Gravitationnelle Novice",'["magie_gravitationnelle"]',1, 1, 0, 3, 0, "esp", 6, "mana", 0, 1, "Augmente la pesanteur autour des membres inférieurs.", "actif", "spe", '{"generate_lestage_cond": {"base": 0, "bonus_si_lestage": 1, "seuil_lestage": 2}, "status": {"root": 1}, "seuil": 2}'),
        ...
        ("grav_lenteur",          "Lenteur Spatiale (Bonus)",      '["magie_gravitationnelle"]', 1, 1, 0, 2, 0, "esp", 3, "mana", 0, 1, "Stoppe tout objet non-vivant en vol dans 5m.", "utilitaire", "spe", '{"rp_effect": "Stoppe/ralentit tout objet non-vivant en vol dans 5m (flèches, rochers)."}'),
        # P2
        ("grav_ecrasement_novice","Écrasement Orbital Novice",     '["magie_gravitationnelle"]', 2, 2, 5, 3, 3, "esp", 8, "mana", 0, 2, "La gravité plaque la cible au sol.", "actif", "spe", '{"generate_lestage": 2, "seuil": 2, "status_if_lestage_3": {"root": 1}}'),
        ("grav_attraction_novice","Attraction Zonale Novice",      '["magie_gravitationnelle"]', 2, 2, 4, 4, 2, "esp", 9, "mana", 0, 2, "Puits de gravité aspirant les corps.", "actif", "spe", '{"generate_lestage": 1, "seuil": 2, "aoe": true}'),
        ("grav_bouclier_novice",  "Bouclier Inertiel Novice",      '["magie_gravitationnelle"]', 2, 2, 0, 3, 0, "esp", 7, "mana", 0, 2, "Redirige la force d'un impact entrant.", "defense", "spe", '{"reduce_dmg_flat": 8, "seuil": 2, "lestage_sur_attaquant": 1}'),
        ("grav_levitation",       "Lévitation Contrôlée (Bonus)",  '["magie_gravitationnelle"]', 2, 2, 0, 1, 0, "esp", 7, "mana", 0, 1, "Vol à 10m de hauteur pendant 5min.", "utilitaire", "spe", '{"rp_effect": "Vous et 2 alliés flottez jusqu\'à 10m pendant 5min. Annule chutes."}'),
        ...
        # P3
        ("grav_traction_avance",  "Traction Avancée",              '["magie_gravitationnelle"]', 3, 3, 9, 4, 3, "esp", 13, "mana", 0, 1, "La masse d'un astre imaginaire s'abat.", "actif", "spe", '{"generate_lestage": 3, "seuil": 2}'),
        ("grav_inversion",        "Champ d'Inversion",             '["magie_gravitationnelle"]', 3, 3, 7, 5, 2, "esp", 15, "mana", 0, 3, "Inverse la gravité d'une zone entière.", "actif", "spe", '{"generate_lestage": 1, "seuil": 3, "status": {"stun": 1}, "aoe": true}'),
        ("grav_compression",      "Onde de Compression",           '["magie_gravitationnelle"]', 3, 3, 6, 4, 2, "esp", 11, "mana", 0, 2, "Compresse l'air autour de la cible.", "actif", "spe", '{"seuil": 2, "ignore_armor_si_alourdi": true, "status_si_alourdi": {"hemorragie": 1}}'),
        ("grav_manteau",          "Manteau Stellaire (Bonus)",     '["magie_gravitationnelle"]', 3, 3, 0, 3, 0, "esp", 12, "mana", 0, 2, "Distorsion gravitationnelle créant une armure.", "defense", "spe", '{"reduce_dmg_flat": 8, "seuil": 2}'),
        ("grav_carto",            "Cartographie Cosmique (Bonus)", '["magie_gravitationnelle"]', 3, 3, 0, 3, 0, "esp", 8, "mana", 0, 1, "Révèle position de toute créature dans 100m.", "utilitaire", "spe", '{"rp_effect": "Révèle position de toute créature dans 100m. Ignore invisibles/illusoires."}'),
        # P4
        ("grav_compression_avance","Compression Gravitationnelle", '["magie_gravitationnelle"]', 4, 4, 13, 4, 5, "esp", 22, "mana", 0, 2, "Broie la cible par pesanteur concentrée.", "actif", "spe", '{"generate_lestage": 4, "seuil": 2, "bonus_si_singularite": 12}'),
        ("grav_effondrement",     "Effondrement de Zone",          '["magie_gravitationnelle"]', 4, 4, 11, 5, 4, "esp", 20, "mana", 0, 3, "Convertit les Lestages en dégâts.", "actif", "spe", '{"consume_lestage_all": true, "dmg_per_lestage": 3, "seuil": 3, "aoe": true}'),
        ("grav_pression_avance",  "Pression Gravitationnelle Avancée",'["magie_gravitationnelle"]',4, 4, 10, 4, 4, "esp", 18, "mana", 0, 2, "La pesanteur triple d'intensité.", "actif", "spe", '{"generate_lestage": 3, "seuil": 3, "double_rupture": true}'),
        ("grav_saut",             "Saut Gravitationnel (Bonus)",   '["magie_gravitationnelle"]', 4, 4, 0, 3, 0, "esp", 18, "mana", 0, 3, "Téléportation vers tout point visible à 300m.", "utilitaire", "spe", '{"rp_effect": "Téléportation instantanée vers tout point visible à moins de 300m."}'),
        ...
        # P5
        ("grav_stellaire",        "Effondrement Stellaire",        '["magie_gravitationnelle"]', 5, 5, 25, 6, 8, "esp", 45, "mana", 0, 4, "La puissance d'un astre mourant s'abat.", "actif", "spe", '{"generate_lestage": 5, "seuil": 4, "aoe": true, "check_singularite_all": true}'),
        ("grav_non_retour",       "Point de Non-Retour",           '["magie_gravitationnelle"]', 5, 5, 18, 5, 7, "esp", 35, "mana", 0, 3, "Distorsion permanente dans la masse de la cible.", "actif", "spe", '{"reset_lestage_plus_2": true, "seuil": 3}'),
        ("grav_bouclier_avance",  "Bouclier Inertiel Avancé",      '["magie_gravitationnelle"]', 5, 5, 0, 5, 0, "esp", 30, "mana", 0, 3, "Sphère gravitationnelle renvoyant les impacts.", "defense", "spe", '{"reduce_dmg_flat": 20, "seuil": 3, "lestage_sur_attaquant_multi": true}'),
        ("grav_dilation",         "Dilation Gravitationnelle (Bonus)",'["magie_gravitationnelle"]',5, 5, 0, 5, 0, "esp", 40, "mana", 0, 5, "Initiative traitée comme la plus haute ce tour.", "utilitaire", "spe", '{"rp_effect": "Ce tour : votre Initiative est traitée comme la plus élevée du combat."}'),
        ("grav_carto_avance",     "Cartographie Cosmique Avancée (Bonus)",'["magie_gravitationnelle"]',5, 5, 0, 3, 0, "esp", 20, "mana", 0, 2, "Révèle position de tout être dans 2km.", "utilitaire", "spe", '{"rp_effect": "Révèle position et déplacement de tout être vivant dans 2km."}'),
        ...
        # P1
        ("ombre_marquage_novice", "Marquage Silencieux",           '["loge_ombre"]', 1, 1, 3, 3, 1, "esp", 6, "mana", 0, 2, "Filament invisible liant le mage à sa proie.", "actif", "spe", '{"pose_designation": 1, "seuil": 1}'),
        ("ombre_voile",           "Voile d'Ombre (Bonus)",         '["loge_ombre"]', 1, 1, 0, 2, 0, "esp", 5, "mana", 0, 1, "Invisibilité 10min.", "utilitaire", "spe", '{"rp_effect": "Invisibilité visuelle 10min (annulée si attaque ou cri)."}'),
        ...
        ("ombre_murmure",         "Murmure de Mana (Bonus)",       '["loge_ombre"]', 1, 1, 0, 2, 0, "esp", 3, "mana", 0, 1, "Écoute conversation à 50m ou intercepte message.", "utilitaire", "spe", '{"rp_effect": "Écoute toute conversation à 50m ou intercepte un message magique."}'),
        ("ombre_frappe_novice",   "Frappe dans l'Ombre Novice",    '["loge_ombre"]', 1, 1, 5, 3, 2, "esp", 7, "mana", 0, 1, "Sort basique amplifié par la préparation.", "actif", "spe", '{"seuil": 2, "bonus_si_designation": {"status": {"root": 1}}}'),
        # P2
        ("ombre_filet_novice",    "Filet Invisible Novice",        '["loge_ombre"]', 2, 2, 5, 3, 2, "esp", 7, "mana", 0, 2, "Réseau de fils coupant les voies d'action.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "ignore_rob_si_designation": true}'),
        ("ombre_perturb_novice",  "Perturbation Neurale Novice",   '["loge_ombre"]', 2, 2, 0, 3, 0, "esp", 8, "mana", 0, 2, "Impulsion brouillant les pensées.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "consomme_designation_bonus": true}'),
        ("ombre_marquage_avance", "Marquage Avancé",               '["loge_ombre"]', 2, 2, 4, 3, 2, "esp", 10, "mana", 0, 2, "Désignation gravée dans l'aura de la cible.", "actif", "spe", '{"pose_designation": 1, "seuil": 2, "bonus_si_deja_designee": 1}'),
        ("ombre_grimage",         "Grimage Parfait (Bonus)",       '["loge_ombre"]', 2, 2, 0, 3, 0, "esp", 6, "mana", 0, 0, "Apparence parfaite d'un PNJ observé.", "utilitaire", "spe", '{"rp_effect": "Transforme apparence physique et vocale en PNJ observé. Dure jusqu\'à blessure."}'),
        ...
        # P3
        ("ombre_marquage_profond","Marquage Profond",              '["loge_ombre"]', 3, 3, 3, 3, 2, "esp", 10, "mana", 0, 2, "Désignation persistante même après consommation.", "actif", "spe", '{"pose_designation": 2, "seuil": 2}'),
        ("ombre_paralysie_novice","Paralysie Neurale Novice",      '["loge_ombre"]', 3, 3, 7, 4, 2, "esp", 12, "mana", 0, 2, "Paralyse le système nerveux supérieur.", "actif", "spe", '{"seuil": 2, "no_bonus_action_next_turn": true}'),
        ("ombre_frappe_avance",   "Frappe dans l'Ombre Avancée",   '["loge_ombre"]', 3, 3, 7, 4, 3, "esp", 14, "mana", 0, 2, "Sort de zone masqué dans un nuage de mana.", "actif", "spe", '{"seuil": 2, "aoe": true, "double_dmg_si_designation": true}'),
        ("ombre_effacement",      "Effacement de Mémoire (Bonus)", '["loge_ombre"]', 3, 3, 0, 3, 0, "esp", 10, "mana", 0, 1, "Efface 1h de mémoire d'un PNJ.", "utilitaire", "spe", '{"rp_effect": "Efface jusqu\'à 1h de mémoire d\'un PNJ ciblé. Ne fonctionne pas sur PJs."}'),
        ("ombre_reseau",          "Réseau Fantôme (Bonus)",        '["loge_ombre"]', 3, 3, 0, 4, 0, "esp", 15, "mana", 0, 2, "3 observateurs magiques invisibles dans une zone.", "utilitaire", "spe", '{"rp_effect": "Place 3 observateurs invisibles dans une zone. 2h de surveillance transmise par le MJ."}'),
        # P4
        ("ombre_sentence_letale", "Sentence Létale",               '["loge_ombre"]', 4, 4, 12, 4, 5, "esp", 20, "mana", 0, 2, "Dégâts massifs ignorant l'Armure. Requiert Désignation.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "seuil": 3}'),
        ("ombre_champ_iso",       "Champ d'Isolation",             '["loge_ombre"]', 4, 4, 0, 4, 0, "esp", 18, "mana", 0, 3, "La cible ne peut cibler plusieurs ennemis ce tour.", "actif", "spe", '{"seuil": 3, "rp_effect": "La cible ne peut pas utiliser sorts de zone ce tour."}'),
        ("ombre_paralysie_avance","Paralysie Neurale Avancée",     '["loge_ombre"]', 4, 4, 9, 4, 3, "esp", 18, "mana", 0, 3, "Coupe les connexions motrices supérieures.", "actif", "spe", '{"seuil": 3, "status": {"stun": 2}, "ignore_rob_si_designation": true}'),
        ("ombre_extraction",      "Extraction d'Information (Bonus)",'["loge_ombre"]', 4, 4, 0, 4, 0, "esp", 15, "mana", 0, 2, "Plonge dans les souvenirs d'une cible inconsciente.", "utilitaire", "spe", '{"rp_effect": "Accède aux souvenirs récents d\'une cible inconsciente. MJ révèle 3 infos."}'),
        ("ombre_poudre",          "Poudre d'Oubli (Bonus)",        '["loge_ombre"]', 4, 4, 0, 4, 0, "esp", 20, "mana", 0, 3, "6 PNJ oublient la Confrérie agir en 10min.", "utilitaire", "spe", '{"rp_effect": "Jusqu\'à 6 PNJ oublient avoir vu la Confrérie agir dans les 10 dernières minutes."}'),
        # P5
        ("ombre_execution",       "Exécution de l'Ombre",          '["loge_ombre"]', 5, 5, 20, 5, 6, "esp", 30, "mana", 0, 2, "La Confrérie a jugé. Dégâts massifs ignorant toute défense.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "ignore_rob": true, "seuil": 3, "execute_note": true}'),
        ("ombre_sentence_avance", "Sentence Létale Avancée",       '["loge_ombre"]', 5, 5, 16, 5, 7, "esp", 35, "mana", 0, 2, "Le Grand Régulateur n'a pas besoin de deux balles.", "actif", "spe", '{"requiert_designation": true, "ignore_armor": true, "seuil": 3, "execute_percent_si_designation": 30}'),
        ("ombre_marquage_fantome","Marquage Fantôme",               '["loge_ombre"]', 5, 5, 2, 3, 1, "esp", 12, "mana", 0, 1, "Pose Désignation après un kill.", "actif", "spe", '{"pose_designation": 1, "seuil": 1}'),
        ("ombre_disparition",     "Disparition Totale (Bonus)",    '["loge_ombre"]', 5, 5, 0, 5, 0, "esp", 35, "mana", 0, 5, "Vous et votre groupe introuvables 24h.", "utilitaire", "spe", '{"rp_effect": "Vous et votre groupe êtes introuvables pendant 24h. Aucun sort de localisation."}'),
        ("ombre_manipulation",    "Manipulation Absolue (Bonus)",  '["loge_ombre"]', 5, 5, 0, 6, 0, "esp", 40, "mana", 0, 5, "Ordre post-hypnotique complexe sur un PNJ.", "utilitaire", "spe", '{"rp_effect": "Ordre post-hypnotique complexe déclenché par une condition précise sur un PNJ."}'),
        ...
        ("estoc_quarte_novice",   "Quarte Novice (Passe ⚔️)",      '["ecole_estoc"]', 1, 1, 4, 3, 2, "phy", 1, "tension", 0, 1, "Dévie la lame adverse. Pose passe_active.", "actif", "spe", '{"pose_passe": true, "seuil": 2}'),
        ("estoc_direct_novice",   "Estoc Direct Novice (Estoc 🎯)",'["ecole_estoc"]', 1, 1, 5, 0, 0, "phy", 1, "tension", 0, 0, "Botte rectiligne 5 dégâts fixes. Si Passe : 0 Tension + Base 8.", "actif", "spe", '{"degats_fixes": 5, "bonus_si_passe": {"base_override": 8, "cout_zero": true}}'),
        ("estoc_feinte",          "Feinte Légère (Bonus)",          '["ecole_estoc"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 1, "Révèle la cible déclarée d'un PNJ.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Combat : révèle cible déclarée d\'un PNJ ce tour."}'),
        ("estoc_prestance",       "Prestance du Cercle (Bonus)",    '["ecole_estoc"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 1, "Avantage en contexte aristocratique.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Dans contexte noble : Avantage automatique sur premier jet d\'Oral ou Force RP."}'),
        ("estoc_mesure",          "Prise de Mesure (Bonus)",        '["ecole_estoc"]', 1, 1, 0, 2, 0, "phy", 0, "tension", 0, 2, "Révèle compétence la plus utilisée par l'ennemi.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Combat : révèle compétence la plus utilisée par ennemi depuis début combat."}'),
        # P2
        ("estoc_sixte",           "Sixte Filée (Passe ⚔️)",        '["ecole_estoc"]', 2, 2, 5, 4, 2, "phy", 1, "tension", 0, 1, "Déviation en arc retournant l'élan adverse.", "actif", "spe", '{"pose_passe": true, "seuil": 2, "status_si_clash_gagne": {"stun": 1}}'),
        ("estoc_botte_novice",    "Botte Secrète Novice (Estoc 🎯)",'["ecole_estoc"]', 2, 2, 7, 4, 2, "phy", 2, "tension", 0, 1, "Exploite l'angle mort révélé par la déviation.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 1}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_desarme",         "Désarmement Partiel",            '["ecole_estoc"]', 2, 2, 0, 3, 0, "phy", 1, "tension", 0, 2, "Tord le poignet avec précision d'horloger.", "actif", "spe", '{"seuil": 2, "rp_effect": "Prochaine attaque de la cible perd 2 Pièces ce tour."}'),
        ...
        ("estoc_analyse",         "Analyse de Combat (Bonus)",      '["ecole_estoc"]', 2, 2, 0, 2, 0, "phy", 0, "tension", 0, 1, "Mémorise patterns adverses.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Prochaine Passe ce combat gagne +1 Pièce supplémentaire."}'),
        # P3
        ("estoc_tierce",          "Tierce Croisée (Passe ⚔️)",     '["ecole_estoc"]', 3, 3, 6, 5, 2, "phy", 2, "tension", 0, 1, "Parade croisée absorbant l'impact.", "actif", "spe", '{"pose_passe": true, "seuil": 2, "status_si_clash_gagne": {"root": 1}}'),
        ("estoc_lunge_novice",    "Lunge Novice (Estoc 🎯)",        '["ecole_estoc"]', 3, 3, 8, 4, 3, "phy", 2, "tension", 0, 1, "Fente explosive couvrant distance impossible.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 2}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_riposte",         "Riposte Foudroyante",            '["ecole_estoc"]', 3, 3, 7, 4, 3, "phy", 2, "tension", 0, 2, "Convertit la Tension récupérée en frappe.", "actif", "spe", '{"seuil": 2, "bonus_si_passe_ce_tour": {"base_bonus": 2}}'),
        ("estoc_honneur",         "Code d'Honneur (Bonus)",         '["ecole_estoc"]', 3, 3, 0, 2, 0, "phy", 0, "tension", 0, 0, "Contrat moral inviolable.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Dans négociation avec règles de conduite claires : interlocuteur contraint moralement."}'),
        ...
        # P4
        ("estoc_parade_absolue",  "Parade Absolue (Passe ⚔️)",     '["ecole_estoc"]', 4, 4, 8, 5, 3, "phy", 2, "tension", 0, 2, "Parade parfaite. passe_active + parade_absorb 5.", "actif", "spe", '{"pose_passe": true, "pose_parade_absorb": 5, "seuil": 3}'),
        ("estoc_botte_avance",    "Botte Secrète Avancée (Estoc 🎯)",'["ecole_estoc"]', 4, 4, 10, 5, 4, "phy", 3, "tension", 0, 1, "La botte parfaite — visible trop tard.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 3}, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_desarme_total",   "Désarmement Total",              '["ecole_estoc"]', 4, 4, 5, 4, 2, "phy", 2, "tension", 0, 3, "La lame vole à dix mètres.", "actif", "spe", '{"seuil": 3, "rp_effect": "La cible ne peut pas utiliser de sort offensif son prochain tour."}'),
        ("estoc_lunge_avance",    "Lunge Avancée (Estoc 🎯)",       '["ecole_estoc"]', 4, 4, 11, 5, 4, "phy", 3, "tension", 0, 2, "Fente si rapide que personne ne la voit.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 3}, "ignore_rob": true, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_defi",            "Défi Officiel (Bonus)",          '["ecole_estoc"]', 4, 4, 0, 2, 0, "phy", 0, "tension", 0, 0, "Cartel signé du sceau du Cercle.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Défi formel à tout personnage de rang équivalent ou supérieur. Refus = perte de réputation."}'),
        # P5
        ("estoc_passe_royale",    "Passe Royale (Passe ⚔️)",       '["ecole_estoc"]', 5, 5, 10, 6, 4, "phy", 3, "tension", 0, 3, "L'arme adverse revient frapper son propriétaire.", "actif", "spe", '{"pose_passe": true, "seuil": 4, "retour_degats_si_marge_3": true}'),
        ("estoc_final",           "Estoc Final (Estoc 🎯)",         '["ecole_estoc"]', 5, 5, 14, 7, 5, "phy", 4, "tension", 0, 2, "Le coup que Maître Valère ne peut décrire.", "actif", "spe", '{"seuil": 4, "status": {"hemorragie": 4}, "execute_percent": 30, "bonus_si_passe": {"cout_zero": true, "coins_bonus": 1}}'),
        ("estoc_riposte_maitre",  "Riposte du Maître (Passe ⚔️)",  '["ecole_estoc"]', 5, 5, 12, 6, 4, "phy", 3, "tension", 0, 2, "Contre-attaque simultanée à la parade.", "actif", "spe", '{"pose_passe": true, "seuil": 3, "status_si_clash_gagne": {"stun": 1, "hemorragie": 2}}'),
        ("estoc_legende",         "Légende du Cercle (Bonus)",      '["ecole_estoc"]', 5, 5, 0, 4, 0, "phy", 0, "tension", 0, 3, "Ennemi inférieur se rend avant le combat.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Ennemi non-boss de niveau inférieur refuse de combattre et se rend ou fuit."}'),
        ...
        # P2
        ("nord_charge_novice",    "Charge Brutale Novice",         '["clan_nord"]', 2, 2, 6, 4, 2, "phy", 2, "tension", 0, 1, "Charge pleine vitesse renversant tout.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}}'),
        ("nord_masse_novice",     "Coup de Masse Novice",          '["clan_nord"]', 2, 2, 7, 0, 0, "phy", 2, "tension", 0, 2, "7 dégâts fixes. Si Serment +4 bonus : Étourdissement.", "actif", "spe", '{"degats_fixes": 7, "stun_si_serment_bonus_4": true}'),
        ("nord_rugissement_avance","Rugissement Avancé",           '["clan_nord"]', 2, 2, 5, 4, 2, "phy", 2, "tension", 0, 2, "Cri brisant la volonté de combattre.", "actif", "spe", '{"seuil": 2, "status": {"hemorragie": 3}, "apply_serment_bonus": true}'),
        ("nord_histoire",         "Histoire du Nord (Bonus)",      '["clan_nord"]', 2, 2, 0, 2, 0, "phy", 0, "tension", 0, 0, "Avantage Intimidation terres du nord.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Avantage jets d\'Intimidation dans terres du nord ou face guerriers qui reconnaissent les marques."}'),
        ...
        # P3
        ("nord_coup_tete_avance", "Coup de Tête Avancé",           '["clan_nord"]', 3, 3, 6, 5, 2, "phy", 2, "tension", 0, 1, "Impact si violent que le sol tremble.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1, "hemorragie": 1}}'),
        ("nord_dechainnement_novice","Déchaînement Novice",        '["clan_nord"]', 3, 3, 9, 5, 3, "phy", 3, "tension", 0, 2, "Rafale de coups. Touche 2ème cible à moitié.", "actif", "spe", '{"seuil": 3, "aoe_reduit": true}'),
        ("nord_briseur_avance",   "Briseur d'Os Avancé",           '["clan_nord"]', 3, 3, 7, 4, 3, "phy", 2, "tension", 0, 2, "Fracasse l'épaule, bras inutilisable.", "actif", "spe", '{"seuil": 3, "rp_effect": "Cible ne peut pas utiliser sort offensif prochain tour.", "status_si_serment": {"hemorragie": 2}}'),
        ("nord_chant",            "Chant de Guerre (Bonus)",       '["clan_nord"]', 3, 3, 0, 3, 0, "phy", 1, "tension", 0, 2, "PNJ de faible volonté hésitent à agir.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Tous PNJ de faible volonté hésitent à agir ce tour."}'),
        ...
        # P4
        ("nord_charge_avance",    "Charge Dévastatrice",           '["clan_nord"]', 4, 4, 10, 6, 3, "phy", 3, "tension", 0, 2, "Charge de titan fracassant armures.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "ignore_armor": true}'),
        ("nord_masse_avance",     "Coup de Masse Avancé",          '["clan_nord"]', 4, 4, 11, 0, 0, "phy", 3, "tension", 0, 2, "11 dégâts fixes. Enracinement.", "actif", "spe", '{"degats_fixes": 11, "status": {"root": 1}}'),
        ("nord_dechainnement_avance","Déchaînement Avancé",        '["clan_nord"]', 4, 4, 11, 6, 4, "phy", 3, "tension", 0, 3, "Si kill : relancer sur nouvelle cible sans Tension.", "actif", "spe", '{"seuil": 3, "kill_relancer": true}'),
        ("nord_survivant",        "Récit du Survivant (Bonus)",    '["clan_nord"]', 4, 4, 0, 2, 0, "phy", 0, "tension", 0, 0, "Cicatrices donnent Avantage négociation.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Mercenaires/soldats accordent respect sans jet. Avantage négociation ou commandement."}'),
        ("nord_sang_tribu",       "Sang de la Tribu (Bonus)",      '["clan_nord"]', 4, 4, 0, 4, 0, "phy", 2, "tension", 0, 5, "1d4 guerriers de la Tribu en renfort 24h.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Dans les 24h, 1d4 guerriers de la Tribu arrivent en renfort (zone de présence tribale requise)."}'),
        # P5
        ("nord_dechainnement_total","Déchaînement Total",          '["clan_nord"]', 5, 5, 14, 7, 5, "phy", 4, "tension", 0, 3, "Rage d'une vie libérée en un instant. Zone.", "actif", "spe", '{"seuil": 4, "status": {"stun": 1}, "aoe": true}'),
        ("nord_masse_final",      "Coup de Masse Final",           '["clan_nord"]', 5, 5, 15, 0, 0, "phy", 4, "tension", 0, 3, "15 dégâts fixes. Ignore Armure. Si Serment <30% : Stun + 4 Hémos.", "actif", "spe", '{"degats_fixes": 15, "ignore_armor": true, "bonus_si_serment_30pct": {"status": {"stun": 1, "hemorragie": 4}}}'),
        ("nord_briseur_final",    "Briseur d'Os Final",            '["clan_nord"]', 5, 5, 11, 6, 4, "phy", 3, "tension", 0, 2, "Corps de l'ennemi cède entièrement.", "actif", "spe", '{"seuil": 4, "ignore_rob": true, "status": {"hemorragie": 4}, "rp_effect": "Cible ne peut pas utiliser sort offensif pendant 2 tours."}'),
        ("nord_terreur",          "Terreur de la Steppe (Bonus)",  '["clan_nord"]', 5, 5, 0, 3, 0, "phy", 0, "tension", 0, 0, "Présence décourage confrontation.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "PNJ doivent réussir jet de Volonté pour oser vous attaquer en premier."}'),
        ("nord_memoire",          "Mémoire Ancestrale (Bonus)",    '["clan_nord"]', 5, 5, 0, 4, 0, "phy", 2, "tension", 0, 4, "Savoir ancestral de la Tribu.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "MJ révèle technique martiale oubliée, info tactique sur ennemi, ou localisation lieu sacré."}'),
        ...
        # P1
        ("legion_frappe_bouclier_novice","Frappe Bouclier Novice", '["legion_fer"]', 1, 1, 4, 3, 2, "phy", 1, "tension", 0, 1, "Percute du plat du bouclier. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "cout_zero_si_posture": true}'),
        ("legion_ancrage_novice", "Ancrage Défensif Novice",       '["legion_fer"]', 1, 1, 3, 3, 2, "phy", 1, "tension", 0, 1, "Creuse ses appuis, refuse toute progression.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "base_bonus_si_posture": 2}'),
        ("legion_tenir",          "Tenir la Ligne (Bonus)",        '["legion_fer"]', 1, 1, 0, 2, 0, "phy", 1, "tension", 0, 1, "Annule effets de déplacement forcé ce tour.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Ce tour : tous effets déplacement forcé annulés. PNJ ordinaire ne peut vous déplacer."}'),
        ...
        # P2
        ("legion_charge_novice",  "Charge Défensive Novice",       '["legion_fer"]', 2, 2, 6, 4, 2, "phy", 2, "tension", 0, 1, "Pas en avant décidé. En Posture : +2 Base.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "base_bonus_si_posture": 2}'),
        ("legion_rempart_novice", "Rempart de Corps Novice",       '["legion_fer"]', 2, 2, 0, 3, 0, "phy", 2, "tension", 0, 2, "Armure 10. En Posture : Armure 15.", "defense", "spe", '{"reduce_dmg_flat": 10, "seuil": 2, "armure_si_posture": 15}'),
        ("legion_frappe_novice",  "Frappe de Bouclier Novice",     '["legion_fer"]', 2, 2, 5, 4, 2, "phy", 2, "tension", 0, 1, "Bouclier en arme de percussion. En Posture : 0 Tension + 1 Pièce.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "cout_zero_si_posture": true, "coins_bonus_si_posture": 1}'),
        ("legion_protocole",      "Protocole de Protection (Bonus)",'["legion_fer"]', 2, 2, 0, 3, 0, "phy", 0, "tension", 0, 1, "Évacuation 20 civils sans jet.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Organise évacuation jusqu\'à 20 civils sans jet. Avantage Survie milieu urbain."}'),
        ("legion_evaluation",     "Évaluation Tactique (Bonus)",   '["legion_fer"]', 2, 2, 0, 2, 0, "phy", 0, "tension", 0, 1, "Révèle si ennemi sous 50% PV.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "MJ confirme si ennemi est sous 50% PV. Identifie cible prioritaire."}'),
        # P3
        ("legion_frappe_avance",  "Frappe Bouclier Avancée",       '["legion_fer"]', 3, 3, 7, 5, 2, "phy", 2, "tension", 0, 1, "Bouclier en arme de brisement. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1, "root": 1}, "cout_zero_si_posture": true}'),
        ("legion_zone_novice",    "Zone de Contrôle Novice",       '["legion_fer"]', 3, 3, 8, 4, 3, "phy", 2, "tension", 0, 2, "Emprise écrasante. Enracinement zone.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "aoe_reduit": true}'),
        ("legion_rempart_avance", "Rempart de Corps Avancé",       '["legion_fer"]', 3, 3, 0, 4, 0, "phy", 3, "tension", 0, 2, "Armure 18 / Posture 24. Rebond 4 dmg si bloqué.", "defense", "spe", '{"reduce_dmg_flat": 18, "seuil": 2, "armure_si_posture": 24, "rebond_si_bloque": 4}'),
        ...
        # P4
        ("legion_bastion_novice", "Bastion Novice",                '["legion_fer"]', 4, 4, 0, 4, 0, "phy", 3, "tension", 0, 3, "Armure 20 pendant 2 tours. En Posture : -5 dmg fixes.", "defense", "spe", '{"reduce_dmg_flat": 20, "seuil": 2, "duree_armure": 2, "reduction_bonus_si_posture": 5}'),
        ("legion_zone_avance",    "Zone de Contrôle Avancée",      '["legion_fer"]', 4, 4, 10, 5, 4, "phy", 3, "tension", 0, 3, "Contrôle absolu. Enracinement + Stun en Posture.", "actif", "spe", '{"seuil": 3, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ("legion_frappe_bouclier_avance","Frappe de Bouclier Avancée",'["legion_fer"]',4, 4, 9, 5, 3, "phy", 3, "tension", 0, 2, "Désarticule l'épaule. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "rp_effect": "Cible ne peut pas utiliser sort offensif prochain tour.", "cout_zero_si_posture": true}'),
        ("legion_presence_rempart","Présence du Rempart (Bonus)",  '["legion_fer"]', 4, 4, 0, 3, 0, "phy", 0, "tension", 0, 0, "Accès ressources locales dans villes protégées.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Dans ville/village protégé : accès logement, nourriture, info, soins. Coopération totale."}'),
        ("legion_serment",        "Serment de la Légion (Bonus)",  '["legion_fer"]', 4, 4, 0, 5, 0, "phy", 3, "tension", 0, 5, "2 légionnaires d'élite en renfort 24h.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Dans les 24h, 2 légionnaires d\'élite arrivent en renfort (villes sous autorité civile uniquement)."}'),
        # P5
        ("legion_zone_absolue",   "Zone de Contrôle Absolue",      '["legion_fer"]', 5, 5, 13, 7, 4, "phy", 4, "tension", 0, 3, "Zone. Enracinement. En Posture : Stun aussi.", "actif", "spe", '{"seuil": 4, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ("legion_bastion_avance", "Bastion Avancé",                '["legion_fer"]', 5, 5, 0, 5, 0, "phy", 4, "tension", 0, 4, "Armure 30 pendant 2 tours. -8 dmg fixes (Posture -3 supp).", "defense", "spe", '{"reduce_dmg_flat": 30, "seuil": 3, "duree_armure": 2, "reduction_fixe": 8, "reduction_bonus_si_posture": 3}'),
        ("legion_frappe_finale",  "Frappe de Bouclier Finale",     '["legion_fer"]', 5, 5, 12, 6, 5, "phy", 4, "tension", 0, 2, "Jugement divin. En Posture : 0 Tension + ignore Armure.", "actif", "spe", '{"seuil": 3, "status": {"root": 1, "stun": 1}, "cout_zero_si_posture": true, "ignore_armor_si_posture": true}'),
        ("legion_memoire",        "Mémoire du Capitaine Oryk (Bonus)",'["legion_fer"]',5, 5, 0, 3, 0, "phy", 0, "tension", 0, 0, "Trêve à toute faction neutre.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Invoquer Légion pour demander trêve à faction neutre/civilisée. Refus = scandale politique."}'),
        ("legion_honneur",        "Honneur de la Légion (Bonus)",  '["legion_fer"]', 5, 5, 0, 4, 0, "phy", 2, "tension", 0, 4, "Invoquer Légion pour arrêter un conflit.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Invoquer Légion de Fer pour arrêter conflit, obtenir reddition ou forcer coopération faction entière."}'),
        ...
        # P1
        ("lotus_frappe_novice",   "Frappe du Lotus Novice",        '["moine_lotus"]', 1, 1, 4, 3, 2, "foi", 8, "ferveur", 0, 1, "Coup au centre de l'énergie vitale.", "actif", "spe", '{"seuil": 2, "status_si_concentre": {"hemorragie": 1}}'),
        ("lotus_infusion_novice", "Infusion Vitale Novice",        '["moine_lotus"]', 1, 1, 4, 3, 2, "foi", 12, "ferveur", 0, 1, "Soin 8 PV. Concentré : +5 PV. Perturbé : moitié.", "soin", "spe", '{"seuil": 2, "soin_base": 8, "concentre_bonus": 5}'),
        ("lotus_posture_novice",  "Posture du Lotus Novice",       '["moine_lotus"]', 1, 1, 0, 3, 0, "foi", 10, "ferveur", 0, 2, "Armure 6. Concentré : 9. Perturbé : 10.", "defense", "spe", '{"seuil": 1, "armure_concentre": 9, "armure_perturbe": 10, "armure_base": 6}'),
        ...
        # P2
        ("lotus_paume_novice",    "Paume du Vide Novice",          '["moine_lotus"]', 2, 2, 5, 3, 3, "foi", 15, "ferveur", 0, 2, "Désactive soins cible ce tour. Concentré : Enracinement.", "actif", "spe", '{"seuil": 2, "no_soin_next_turn": true, "status_si_concentre": {"root": 1}}'),
        ("lotus_transfert_novice","Transfert de Flux Novice",      '["moine_lotus"]', 2, 2, 5, 3, 2, "foi", 18, "ferveur", 0, 2, "Soin 12 PV allié, perd 4 PV. Concentré : +5/−2.", "soin", "spe", '{"seuil": 2, "soin_base": 12, "concentre_bonus": 5, "self_dmg": 4, "self_dmg_concentre": 2}'),
        ("lotus_frappe_eveil_novice","Frappe d'Éveil Novice",      '["moine_lotus"]', 2, 2, 6, 4, 2, "foi", 12, "ferveur", 0, 1, "Dégâts physiques. Perturbé : ignore Rob. Concentré : +5 Ferveur.", "actif", "spe", '{"seuil": 2, "ignore_rob_si_perturbe": true, "ferveur_si_concentre": 5}'),
        ("lotus_enseignement",    "Enseignement du Lotus (Bonus)", '["moine_lotus"]', 2, 2, 0, 2, 0, "foi", 8, "ferveur", 0, 0, "Expert corps, poisons, arts martiaux.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Expert niveau sur corps humain, poisons, arts martiaux, spiritualité. Avantage Médecine/Religion/Sciences."}'),
        ...
        # P3
        ("lotus_frappe_avance",   "Frappe du Lotus Avancée",       '["moine_lotus"]', 3, 3, 8, 4, 3, "foi", 20, "ferveur", 0, 1, "Flux vital retourné. Concentré : -5 Ferveur cible. Perturbé : +4 Base.", "actif", "spe", '{"seuil": 3, "status": {"hemorragie": 2}, "ferveur_cible_si_concentre": -5, "ignore_armor_si_perturbe": true}'),
        ("lotus_sceau_novice",    "Sceau du Lotus Novice",         '["moine_lotus"]', 3, 3, 6, 3, 3, "foi", 22, "ferveur", 1, 2, "Soin 14 PV + dissipe 1 négatif. Concentré : +5.", "soin", "spe", '{"seuil": 2, "soin_base": 14, "concentre_bonus": 5, "cleanse_target": true}'),
        ("lotus_paume_avance",    "Paume du Vide Avancée",         '["moine_lotus"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 2, "Stun. Concentré : no regen adversaire. Perturbé : +4 Base.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_concentre": true, "status_si_perturbe": {"root": 1}}'),
        ("lotus_perception",      "Perception du Flux (Bonus)",    '["moine_lotus"]', 3, 3, 0, 3, 0, "foi", 10, "ferveur", 0, 1, "État de santé réel de tous dans 15m.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Identifie état de santé réel de tous êtres vivants dans 15m (blessures cachées, maladies, poisons)."}'),
        ("lotus_ancrage",         "Ancrage Mental (Bonus)",        '["moine_lotus"]', 3, 3, 0, 2, 0, "foi", 8, "ferveur", 0, 1, "Dissipe 1 effet contrôle mental.", "utilitaire", "spe", '{"seuil": 1, "cleanse_self": true, "rp_effect": "Dissipe 1 effet contrôle mental/peur. Immunisé intimidation/manipulation ordinaire."}'),
        # P4
        ("lotus_sceau_avance",    "Sceau du Lotus Avancé",         '["moine_lotus"]', 4, 4, 10, 4, 4, "foi", 30, "ferveur", 2, 2, "Soin 22 PV + dissipe tous négatifs. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 22, "concentre_bonus": 5, "cleanse_target": true, "cleanse_all": true}'),
        ("lotus_frappe_eveil_avance","Frappe de l'Éveil Avancée",  '["moine_lotus"]', 4, 4, 10, 5, 3, "foi", 28, "ferveur", 0, 2, "Stun. Concentré : no regen. Perturbé : +4 Base + ignore Armure+Rob.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_concentre": true, "ignore_armor_rob_si_perturbe": true}'),
        ("lotus_transfert_total_novice","Transfert Total Novice",  '["moine_lotus"]', 4, 4, 8, 4, 4, "foi", 35, "ferveur", 2, 3, "Soin 25 PV allié, perd 8 PV. Concentré : +5.", "soin", "spe", '{"seuil": 3, "soin_base": 25, "concentre_bonus": 5, "self_dmg": 8}'),
        ("lotus_secret",          "Secret du Monastère (Bonus)",   '["moine_lotus"]', 4, 4, 0, 3, 0, "foi", 15, "ferveur", 1, 1, "Connaissance interdite du Temple.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Temple révèle connaissance interdite : org secrète, poison rare, technique oubliée ou maladie incurable."}'),
        ("lotus_herbo_cimes",     "Herboristerie des Cimes (Bonus)",'["moine_lotus"]', 4, 4, 0, 2, 0, "foi", 10, "ferveur", 0, 3, "Décoction soignant 15 PV hors combat.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Prépare décoction en 10min : soigne 15 PV hors combat, dissipe Poison ou stabilise KO. Stockable."}'),
        # P5
        ("lotus_frappe_finale",   "Frappe de l'Éveil Finale",      '["moine_lotus"]', 5, 5, 14, 5, 5, "foi", 40, "ferveur", 0, 2, "Dégâts massifs. 3 Hémos. Ignore Armure. Rob cible -3.", "actif", "spe", '{"seuil": 4, "status": {"hemorragie": 3}, "ignore_armor": true, "reduce_rob_cible": 3}'),
        ("lotus_transfert_final", "Transfert Total Avancé",        '["moine_lotus"]', 5, 5, 18, 4, 5, "foi", 50, "ferveur", 4, 3, "Soin 40 PV allié + dissipe tous négatifs, perd 15 PV.", "soin", "spe", '{"seuil": 3, "soin_base": 40, "concentre_bonus": 5, "self_dmg": 15, "cleanse_target": true, "cleanse_all": true}'),
        ("lotus_sceau_final",     "Sceau du Lotus Final",          '["moine_lotus"]', 5, 5, 12, 5, 5, "foi", 45, "ferveur", 3, 3, "Soin 35 PV + dissipe tous + Armure 15 1 tour.", "soin", "spe", '{"seuil": 4, "soin_base": 35, "cleanse_target": true, "cleanse_all": true, "self_status": {"armure": 15}}'),
        ("lotus_noir",            "Lotus Noir (Bonus)",            '["moine_lotus"]', 5, 5, 0, 4, 0, "foi", 35, "ferveur", 3, 5, "Purification profonde d'un traumatisme.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Cible consentante affronte pires regrets. Dissipe effets mentaux permanents, malédictions ou compétences bloquées."}'),
        ("lotus_detachement",     "Détachement du Moine (Bonus)",  '["moine_lotus"]', 5, 5, 0, 3, 0, "foi", 20, "ferveur", 2, 3, "Résistance mentale absolue 1 scène.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Résistance mentale absolue pendant 1 scène. Aucune manipulation ou magie mentale."}'),
        ...
        # P2
        ("oracle_deviation_novice","Déviation de Trajectoire Novice",'["oracle"]', 2, 2, 0, 3, 0, "foi", 18, "ferveur", 0, 2, "Réduit prochaine attaque ciblant allié de (Foi).", "defense", "spe", '{"seuil": 2, "protect_allie_foi": true}'),
        ("oracle_frappe_premo_novice","Frappe Prémonitoire Novice",'["oracle"]', 2, 2, 6, 3, 3, "foi", 15, "ferveur", 0, 1, "Dégâts sacrés. Présage exact : +3 Base.", "actif", "spe", '{"seuil": 2, "base_bonus_si_presage": 3}'),
        ("oracle_entrave_avance", "Entrave du Destin Avancée",     '["oracle"]', 2, 2, 5, 4, 2, "foi", 16, "ferveur", 0, 1, "Dégâts sacrés. Enracinement + Étourdissement.", "actif", "spe", '{"seuil": 2, "status": {"root": 1, "stun": 1}}'),
        ("oracle_bassin",         "Bassin des Reflets (Bonus)",    '["oracle"]', 2, 2, 0, 2, 0, "foi", 12, "ferveur", 0, 1, "1 info sur personne/lieu/événement passé.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Dans surface réfléchissante : MJ révèle 1 info sur personne, lieu ou événement passé lié à cet endroit."}'),
        ...
        # P3
        ("oracle_inversion_novice","Inversion de Probabilité Novice",'["oracle"]', 3, 3, 0, 3, 0, "foi", 20, "ferveur", 2, 2, "Prochain jet cible : toutes pièces Pile.", "actif", "spe", '{"seuil": 2, "force_pile_next": true}'),
        ("oracle_frappe_premo_avance","Frappe Prémonitoire Avancée",'["oracle"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 1, "Dégâts sacrés. Présage exact : +5 Base + ignore Rob.", "actif", "spe", '{"seuil": 3, "base_bonus_si_presage": 5, "ignore_rob_si_presage": true}'),
        ("oracle_touche_avance",  "Touche du Destin Avancée",      '["oracle"]', 3, 3, 0, 4, 0, "foi", 22, "ferveur", 0, 2, "Stun. Présage exact : cible no regen ce tour.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "no_regen_si_presage": true}'),
        ("oracle_carto",          "Cartographie du Destin (Bonus)",'["oracle"]', 3, 3, 0, 3, 0, "foi", 15, "ferveur", 0, 1, "Conséquences probables d'une décision.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "MJ révèle conséquences probables d\'une décision majeure (orienté, pas certain)."}'),
        ...
        # P4
        ("oracle_deviation_totale","Déviation Totale",             '["oracle"]', 4, 4, 0, 4, 0, "foi", 30, "ferveur", 3, 3, "Annule prochaine attaque sur allié. Dégâts à 0.", "defense", "spe", '{"seuil": 3, "annule_attaque_allie": true}'),
        ("oracle_inversion_avance","Inversion de Probabilité Avancée",'["oracle"]',4, 4, 0, 5, 0, "foi", 28, "ferveur", 3, 3, "Zone : tous ennemis pièces Pile ce tour.", "actif", "spe", '{"seuil": 3, "force_pile_zone": true, "aoe": true}'),
        ("oracle_frappe_noeud",   "Frappe du Nœud",                '["oracle"]', 4, 4, 11, 5, 4, "foi", 30, "ferveur", 0, 2, "Ignore Rob. Présage exact : +5 Base + Stun.", "actif", "spe", '{"seuil": 3, "ignore_rob": true, "base_bonus_si_presage": 5, "status_si_presage": {"stun": 1}}'),
        ("oracle_entrevision",    "Entrevision (Bonus)",           '["oracle"]', 4, 4, 0, 4, 0, "foi", 25, "ferveur", 2, 2, "Scène passée ou future (6h max) liée à objet.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "MJ révèle scène du passé ou futur proche (6h max) liée à personne ou objet. Véridique mais métaphorique."}'),
        ("oracle_synchro",        "Synchronisation Cosmique (Bonus)",'["oracle"]', 4, 4, 0, 3, 0, "foi", 20, "ferveur", 1, 2, "Contact mental 10min avec l'Ordre.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Contact mental 10min avec l\'Ordre. Transmission/réception infos, visions, alertes en temps réel."}'),
        # P5
        ("oracle_noeud_destin",   "Nœud du Destin",                '["oracle"]', 5, 5, 15, 5, 6, "foi", 45, "ferveur", 5, 3, "Dégâts massifs ignorant toute défense. Stun 2 tours.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "status": {"stun": 2}}'),
        ("oracle_deviation_absolue","Déviation Absolue",           '["oracle"]', 5, 5, 0, 5, 0, "foi", 40, "ferveur", 4, 4, "Redirige attaque ciblant allié vers un ennemi.", "defense", "spe", '{"seuil": 4, "redirection_attaque": true}'),
        ("oracle_frappe_noeud_avance","Frappe du Nœud Avancée",    '["oracle"]', 5, 5, 14, 6, 5, "foi", 40, "ferveur", 0, 2, "Ignore toute défense. Présage exact <30% PV : Exécution.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "execute_percent_si_presage": 30}'),
        ("oracle_prophetie",      "Prophétie de l'Ordre (Bonus)",  '["oracle"]', 5, 5, 0, 4, 0, "foi", 60, "ferveur", 6, 5, "Prophétie publique se réalisant dans la session.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "Prononcez prophétie publique. MJ garantit réalisation dans cette session ou la suivante."}'),
        ("oracle_eternite",       "Regard de l'Éternité (Bonus)",  '["oracle"]', 5, 5, 0, 4, 0, "foi", 40, "ferveur", 3, 3, "Communique avec esprit d'un défunt non résolu.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Communique brièvement (5min) avec esprit défunt dont mort non résolue."}'),
        ...
        # P1
        ("inq_jugement_novice",   "Jugement Novice",               '["inquisiteur"]', 1, 1, 5, 3, 2, "foi", 12, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : +3 Base + 1 Brûlure.", "actif", "spe", '{"seuil": 2, "bonus_si_condamne": {"base_bonus": 3, "status": {"brulure": 1}}}'),
        ("inq_frappe_novice",     "Frappe d'Inquisition Novice",   '["inquisiteur"]', 1, 1, 4, 3, 2, "foi", 10, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : Enracinement.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"root": 1}}'),
        ("inq_aveu",              "Aveu Forcé (Bonus)",            '["inquisiteur"]', 1, 1, 0, 2, 0, "foi", 8, "ferveur", 0, 1, "Force PNJ à répondre véridiquement.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Force PNJ à répondre véridiquement à 1 question. Pas PJs ni Foi égale/sup."}'),
        ...
        ("inq_sceau",             "Sceau d'Anathème (Bonus)",      '["inquisiteur"]', 1, 1, 0, 2, 0, "foi", 5, "ferveur", 0, 1, "Marque invisible reconnaissable par la Confrérie.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Appose marque invisible sur cible. Tout membre Confrérie sait qu\'elle est Condamnée."}'),
        # P2
        ("inq_chatiment_novice",  "Châtiment Novice",              '["inquisiteur"]', 2, 2, 6, 4, 2, "foi", 18, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : Étourdissement.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"stun": 1}}'),
        ("inq_purif",             "Purification Forcée",           '["inquisiteur"]', 2, 2, 0, 3, 0, "foi", 15, "ferveur", 0, 2, "Dissipe tous effets actifs. Si Condamnée : no buff reste combat.", "actif", "spe", '{"seuil": 2, "cleanse_target": true, "cleanse_all": true, "no_buff_si_condamne": true}'),
        ("inq_frappe_avance",     "Frappe d'Inquisition Avancée",  '["inquisiteur"]', 2, 2, 7, 4, 3, "foi", 16, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : Stun + 2 Brûlures.", "actif", "spe", '{"seuil": 2, "status_si_condamne": {"stun": 1, "brulure": 2}}'),
        ("inq_archives",          "Archives de la Confrérie (Bonus)",'["inquisiteur"]',2, 2, 0, 2, 0, "foi", 10, "ferveur", 0, 0, "Passé, affiliations, crimes, faiblesses d'une personne.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Réseau Bureau Secret : passé, affiliations, crimes, faiblesses d\'une personne ou org en quelques heures."}'),
        ("inq_interrogatoire",    "Interrogatoire Expert (Bonus)", '["inquisiteur"]', 2, 2, 0, 3, 0, "foi", 8, "ferveur", 0, 1, "Extrait 3 informations vraies d'un PNJ.", "utilitaire", "spe", '{"seuil": 1, "rp_effect": "Lors d\'interrogatoire : extrait 3 informations vraies d\'un PNJ (sans violence si Foi > résistance morale)."}'),
        # P3
        ("inq_jugement_avance",   "Jugement Avancé",               '["inquisiteur"]', 3, 3, 9, 4, 3, "foi", 25, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : 3 Brûlures + Stun.", "actif", "spe", '{"seuil": 3, "status_si_condamne": {"brulure": 3, "stun": 1}}'),
        ("inq_contre_esp_novice", "Contre-Espionnage Novice",      '["inquisiteur"]', 3, 3, 0, 3, 0, "foi", 20, "ferveur", 0, 2, "Révèle invisibles/déguisés dans 50m.", "actif", "spe", '{"seuil": 2, "cleanse_furtif": true, "rp_effect": "Révèle toute personne invisible/déguisée/en filature dans 50m."}'),
        ("inq_chatiment_avance",  "Châtiment Avancé",              '["inquisiteur"]', 3, 3, 8, 4, 3, "foi", 22, "ferveur", 0, 1, "Dégâts sacrés. Si Condamnée : Stun 2 tours + ignore Rob.", "actif", "spe", '{"seuil": 3, "status_si_condamne": {"stun": 2}, "ignore_rob_si_condamne": true}'),
        ("inq_verite",            "Vérité Absolue (Bonus)",        '["inquisiteur"]', 3, 3, 0, 3, 0, "foi", 20, "ferveur", 2, 2, "Zone 10m où aucun mensonge possible.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Crée zone 10m où aucun mensonge possible pendant 10min. MJ valide réponses."}'),
        ...
        # P4
        ("inq_chatiment_divin",   "Châtiment Divin",               '["inquisiteur"]', 4, 4, 11, 5, 4, "foi", 32, "ferveur", 0, 2, "Dégâts sacrés massifs. Si Condamnée : Stun 2 tours + ignore Armure.", "actif", "spe", '{"seuil": 3, "ignore_armor_si_condamne": true, "status_si_condamne": {"stun": 2}}'),
        ("inq_purif_totale",      "Purification Totale",           '["inquisiteur"]', 4, 4, 0, 4, 0, "foi", 25, "ferveur", 2, 3, "Dissipe TOUT. Si Condamnée : no buff reste combat + résistances.", "actif", "spe", '{"seuil": 3, "cleanse_target": true, "cleanse_all": true, "no_buff_si_condamne": true}'),
        ("inq_contre_esp_avance", "Contre-Espionnage Avancé",      '["inquisiteur"]', 4, 4, 8, 4, 3, "foi", 25, "ferveur", 0, 2, "Révèle et Condamne automatiquement ennemis Furtifs.", "actif", "spe", '{"seuil": 3, "condamne_furtifs": true, "aoe": true}'),
        ("inq_effacement",        "Effacement de Dossier (Bonus)", '["inquisiteur"]', 4, 4, 0, 3, 0, "foi", 20, "ferveur", 2, 2, "Efface identité d'une personne dans une ville.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Efface existence administrative, sociale et criminelle d\'une personne dans une ville. Ne peut cibler PJs."}'),
        ("inq_reseau",            "Réseau d'Inquisition (Bonus)",  '["inquisiteur"]', 4, 4, 0, 4, 0, "foi", 25, "ferveur", 2, 3, "Surveillance totale d'une cible 48h.", "utilitaire", "spe", '{"seuil": 2, "rp_effect": "Cible sous surveillance totale 48h. MJ informe de chaque mouvement important."}'),
        # P5
        ("inq_jugement_final",    "Jugement Final",                '["inquisiteur"]', 5, 5, 18, 6, 6, "foi", 50, "ferveur", 6, 4, "Dégâts sacrés massifs. Condamnée <20% PV : Exécution.", "actif", "spe", '{"seuil": 4, "execute_percent_si_condamne": 20}'),
        ("inq_contre_esp_total",  "Contre-Espionnage Total",       '["inquisiteur"]', 5, 5, 12, 5, 4, "foi", 35, "ferveur", 0, 2, "Zone : dissipe tous Furtifs/illusions. Tous révélés = Condamnés.", "actif", "spe", '{"seuil": 3, "cleanse_furtif": true, "condamne_tous_reveles": true, "aoe": true}'),
        ("inq_chatiment_absolu",  "Châtiment Absolu",              '["inquisiteur"]', 5, 5, 14, 6, 5, "foi", 40, "ferveur", 0, 3, "Ignore toute défense. Condamnée : Stun 2 tours + 5 Brûlures.", "actif", "spe", '{"seuil": 4, "ignore_armor": true, "ignore_rob": true, "status_si_condamne": {"stun": 2, "brulure": 5}}'),
        ("inq_confession",        "Confession Finale (Bonus)",     '["inquisiteur"]', 5, 5, 0, 6, 0, "foi", 70, "ferveur", 8, 5, "Question absolue — l'univers répond véridiquement.", "utilitaire", "spe", '{"seuil": 4, "rp_effect": "Posez question absolue sur mystère, org ou personne. MJ répond véridiquement et complètement."}'),
        ("inq_disparition",       "Disparition Administrative (Bonus)",'["inquisiteur"]',5, 5, 0, 5, 0, "foi", 40, "ferveur", 4, 5, "Fait disparaître un PNJ de la circulation 24h.", "utilitaire", "spe", '{"seuil": 3, "rp_effect": "PNJ disparaît de la circulation sans trace en 24h. Ne peut cibler PJs."}'),
