...
def populate_spells():
    ...
    sorts = [
        ...
        # P1
        ("legion_frappe_bouclier_novice","Frappe Bouclier Novice", '["legion_fer"]', 1, 1, 4, 3, 2, "phy", 1, "tension", 0, 2, "Percute du plat du bouclier. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "cout_zero_si_posture": true}'),
        ("legion_ancrage_novice", "Ancrage Défensif Novice",       '["legion_fer"]', 1, 1, 3, 3, 2, "phy", 1, "tension", 0, 2, "Creuse ses appuis, refuse toute progression.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "base_bonus_si_posture": 2}'),
        ...
        # P2
        ("legion_charge_novice",  "Charge Défensive Novice",       '["legion_fer"]', 2, 2, 6, 4, 2, "phy", 2, "tension", 0, 2, "Pas en avant décidé. En Posture : +2 Base.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "base_bonus_si_posture": 2}'),
        ...
        ("legion_frappe_novice",  "Frappe de Bouclier Novice",     '["legion_fer"]', 2, 2, 5, 4, 2, "phy", 2, "tension", 0, 2, "Bouclier en arme de percussion. En Posture : 0 Tension + 1 Pièce.", "actif", "spe", '{"seuil": 2, "status": {"stun": 1}, "cout_zero_si_posture": true, "coins_bonus_si_posture": 1}'),
        ...
        # P3
        ("legion_frappe_avance",  "Frappe Bouclier Avancée",       '["legion_fer"]', 3, 3, 7, 5, 2, "phy", 2, "tension", 0, 2, "Bouclier en arme de brisement. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1, "root": 1}, "cout_zero_si_posture": true}'),
        ("legion_zone_novice",    "Zone de Contrôle Novice",       '["legion_fer"]', 3, 3, 8, 4, 3, "phy", 2, "tension", 0, 3, "Emprise écrasante. Enracinement zone.", "actif", "spe", '{"seuil": 2, "status": {"root": 1}, "aoe_reduit": true}'),
        ...
        ("legion_zone_avance",    "Zone de Contrôle Avancée",      '["legion_fer"]', 4, 4, 10, 5, 4, "phy", 3, "tension", 0, 4, "Contrôle absolu. Enracinement + Stun en Posture.", "actif", "spe", '{"seuil": 3, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ("legion_frappe_bouclier_avance","Frappe de Bouclier Avancée",'["legion_fer"]',4, 4, 9, 5, 3, "phy", 3, "tension", 0, 3, "Désarticule l'épaule. En Posture : 0 Tension.", "actif", "spe", '{"seuil": 3, "status": {"stun": 1}, "rp_effect": "Cible ne peut pas utiliser sort offensif prochain tour.", "cout_zero_si_posture": true}'),
        ...
        # P5
        ("legion_zone_absolue",   "Zone de Contrôle Absolue",      '["legion_fer"]', 5, 5, 13, 7, 4, "phy", 4, "tension", 0, 4, "Zone. Enracinement. En Posture : Stun aussi.", "actif", "spe", '{"seuil": 4, "status": {"root": 1}, "status_si_posture": {"stun": 1}, "aoe": true}'),
        ...
        ("legion_frappe_finale",  "Frappe de Bouclier Finale",     '["legion_fer"]', 5, 5, 12, 6, 5, "phy", 4, "tension", 0, 3, "Jugement divin. En Posture : 0 Tension + ignore Armure.", "actif", "spe", '{"seuil": 3, "status": {"root": 1, "stun": 1}, "cout_zero_si_posture": true, "ignore_armor_si_posture": true}'),
